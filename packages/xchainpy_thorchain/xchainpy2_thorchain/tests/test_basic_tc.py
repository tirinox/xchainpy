...
@pytest.mark.parametrize('coin, amount', [
    (Coin(124, 'rune'), CryptoAmount(Amount.auto_base(124, RUNE_DECIMAL), AssetRUNE)),
    (Coin(123455, 'eth/eth'), CryptoAmount(Amount.auto_base(123455, RUNE_DECIMAL), AssetETH.as_synth))
])
