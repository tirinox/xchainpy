...
class TransactionsApi(object):
    ...
    def tx_in_voter(self, hash, **kwargs):  # noqa: E501
        """tx_in_voter  # noqa: E501

        Returns the inbound transaction voter for a provided hash.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.tx_in_voter(hash, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.tx_in_voter_with_http_info(hash, **kwargs)  # noqa: E501
        else:
            (data) = self.tx_in_voter_with_http_info(hash, **kwargs)  # noqa: E501
            return data

    def tx_in_voter_with_http_info(self, hash, **kwargs):  # noqa: E501
        """tx_in_voter  # noqa: E501

        Returns the inbound transaction voter for a provided hash.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.tx_in_voter_with_http_info(hash, async_req=True)
        >>> result = thread.get()
        ...
        if ('hash' not in params or
                params['hash'] is None):
            raise ValueError("Missing the required parameter `hash` when calling `tx_in_voter`")  # noqa: E501
    ...
    def tx_out_voter(self, hash, **kwargs):  # noqa: E501
        """tx_out_voter  # noqa: E501

        Returns the outbound transaction voter for a provided hash.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.tx_out_voter(hash, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.tx_out_voter_with_http_info(hash, **kwargs)  # noqa: E501
        else:
            (data) = self.tx_out_voter_with_http_info(hash, **kwargs)  # noqa: E501
            return data

    def tx_out_voter_with_http_info(self, hash, **kwargs):  # noqa: E501
        """tx_out_voter  # noqa: E501

        Returns the outbound transaction voter for a provided hash.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.tx_out_voter_with_http_info(hash, async_req=True)
        >>> result = thread.get()
        ...
        if ('hash' not in params or
                params['hash'] is None):
            raise ValueError("Missing the required parameter `hash` when calling `tx_out_voter`")  # noqa: E501
    ...
    def tx_signers_old(self, hash, **kwargs):  # noqa: E501
        ...
        Deprecated - migrate to /mayachain/tx/details.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
