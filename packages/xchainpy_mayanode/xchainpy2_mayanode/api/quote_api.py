...
class QuoteApi(object):
    ...
    def quoteswap_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['height', 'from_asset', 'to_asset', 'amount', 'destination', 'streaming_interval', 'streaming_quantity', 'tolerance_bps', 'liquidity_tolerance_bps', 'affiliate_bps', 'affiliate']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
