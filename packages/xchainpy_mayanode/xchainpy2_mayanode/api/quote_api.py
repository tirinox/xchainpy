...
class QuoteApi(object):
    ...
    def quoteswap(self, **kwargs):  # noqa: E501
        ...
        :param str affiliate_bps: the affiliate fee in basis points; use \"/\" to separate multiple values
        :param str affiliate: the affiliate (address or mayaname); use \"/\" to separate multiple values
