...
class InboundAddress(object):
    ...
    swagger_types = {
        ...
        'outbound_fee': 'str',
        'dust_threshold': 'str',
        'shielded_memo_config': 'ShieldedMemoConfig'
    }
    ...
    attribute_map = {
        ...
        'shielded_memo_config': 'shielded_memo_config'
    }

    def __init__(self, chain=None, pub_key=None, address=None, router=None, halted=None, global_trading_paused=None, chain_trading_paused=None, chain_lp_actions_paused=None, observed_fee_rate=None, gas_rate=None, gas_rate_units=None, outbound_tx_size=None, outbound_fee=None, dust_threshold=None, shielded_memo_config=None):  # noqa: E501
        ...
        self._shielded_memo_config = None
        ...
        if shielded_memo_config is not None:
            self.shielded_memo_config = shielded_memo_config
    ...
    def observed_fee_rate(self):
        ...
        The chain's observed fee rate in gas_rate_units (see gas_rate_units), before the 1.5x that makes an outbound more likely to have a sufficient gas rate.  Used by validators to check whether they need to report a fee change.  # noqa: E501
    ...
    @property
    def shielded_memo_config(self):
        """Gets the shielded_memo_config of this InboundAddress.  # noqa: E501


        :return: The shielded_memo_config of this InboundAddress.  # noqa: E501
        :rtype: ShieldedMemoConfig
        """
        return self._shielded_memo_config

    @shielded_memo_config.setter
    def shielded_memo_config(self, shielded_memo_config):
        """Sets the shielded_memo_config of this InboundAddress.


        :param shielded_memo_config: The shielded_memo_config of this InboundAddress.  # noqa: E501
        :type: ShieldedMemoConfig
        """

        self._shielded_memo_config = shielded_memo_config
