...
class InboundAddress(object):
    ...
    def __init__(self, chain=None, pub_key=None, address=None, router=None, halted=None, global_trading_paused=None, chain_trading_paused=None, chain_lp_actions_paused=None, gas_rate=None, gas_rate_units=None, outbound_tx_size=None, outbound_fee=None, dust_threshold=None, shielded_memo_config=None):  # noqa: E501
