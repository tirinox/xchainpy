...
class ObservedTx(object):
    ...
    attribute_map = {
        ...
        'observed_pub_key_eddsa': 'observed_pub_key_eddsa',
    ...
    def __init__(self, tx=None, observed_pub_key=None, observed_pub_key_eddsa=None, external_observed_height=None, external_confirmation_delay_height=None, aggregator=None, aggregator_target=None, aggregator_target_limit=None, signers=None, keysign_ms=None, out_hashes=None, status=None, block_height=None, finalise_height=None):  # noqa: E501
        """ObservedTx - a model defined in Swagger"""  # noqa: E501
        self._tx = None
        self._observed_pub_key = None
        self._observed_pub_key_eddsa = None
        ...
        if observed_pub_key_eddsa is not None:
            self.observed_pub_key_eddsa = observed_pub_key_eddsa
    ...
    @property
    def observed_pub_key_eddsa(self):
        """Gets the observed_pub_key_eddsa of this ObservedTx.  # noqa: E501


        :return: The observed_pub_key_eddsa of this ObservedTx.  # noqa: E501
        :rtype: str
        """
        return self._observed_pub_key_eddsa

    @observed_pub_key_eddsa.setter
    def observed_pub_key_eddsa(self, observed_pub_key_eddsa):
        """Sets the observed_pub_key_eddsa of this ObservedTx.


        :param observed_pub_key_eddsa: The observed_pub_key_eddsa of this ObservedTx.  # noqa: E501
        :type: str
        """

        self._observed_pub_key_eddsa = observed_pub_key_eddsa

    @property
    def external_observed_height(self):
        """Gets the external_observed_height of this ObservedTx.  # noqa: E501

        the block height on the external source chain when the transaction was observed, not provided if chain is maya  # noqa: E501
    ...
    def external_confirmation_delay_height(self):
        ...
        the block height on the external source chain when confirmation counting will be complete, not provided if chain is maya  # noqa: E501
