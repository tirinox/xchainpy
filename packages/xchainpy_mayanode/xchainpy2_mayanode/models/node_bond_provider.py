...
class NodeBondProvider(object):
    ...
    def __init__(self, bond_address=None, bonded=None, bond=None, reward=None, pools=None):  # noqa: E501
    ...
    def bond(self):
        ...
        Total amount of bond provided by the provider in cacao  # noqa: E501
    ...
    @property
    def pools(self):
        """Gets the pools of this NodeBondProvider.  # noqa: E501

        Pools and the respective units bonded by the provider to this node  # noqa: E501

        :return: The pools of this NodeBondProvider.  # noqa: E501
        :rtype: dict(str, str)
        """
        return self._pools
    ...
    def pools(self, pools):
        """Sets the pools of this NodeBondProvider.

        Pools and the respective units bonded by the provider to this node  # noqa: E501

        :param pools: The pools of this NodeBondProvider.  # noqa: E501
        :type: dict(str, str)
        """
        if pools is None:
