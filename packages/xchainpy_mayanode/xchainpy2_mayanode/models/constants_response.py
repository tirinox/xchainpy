...
class ConstantsResponse(object):
    ...
    def __init__(self, int64_values=None, bool_values=None, string_values=None):  # noqa: E501
        """ConstantsResponse - a model defined in Swagger"""  # noqa: E501
        self._int64_values = None
        self._bool_values = None
        self._string_values = None
        self.discriminator = None
        if int64_values is not None:
            self.int64_values = int64_values
    ...
    def int64_values(self):
        """Gets the int64_values of this ConstantsResponse.  # noqa: E501


        :return: The int64_values of this ConstantsResponse.  # noqa: E501
        :rtype: dict(str, str)
        """
        return self._int64_values

    @int64_values.setter
    def int64_values(self, int64_values):
        """Sets the int64_values of this ConstantsResponse.


        :param int64_values: The int64_values of this ConstantsResponse.  # noqa: E501
        :type: dict(str, str)
        """

        self._int64_values = int64_values
