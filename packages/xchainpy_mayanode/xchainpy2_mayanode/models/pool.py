...
class Pool(object):
    ...
    def __init__(self, balance_cacao=None, balance_asset=None, asset=None, lp_units=None, pool_units=None, status=None, decimals=None, synth_units=None, synth_supply=None, pending_inbound_cacao=None, pending_inbound_asset=None, savers_depth=None, savers_units=None, synth_mint_paused=None, bondable=None):  # noqa: E501
    ...
    @property
    def bondable(self):
        """Gets the bondable of this Pool.  # noqa: E501

        whether LPs can bond liquidity in the pool to a node  # noqa: E501

        :return: The bondable of this Pool.  # noqa: E501
        :rtype: bool
        """
        return self._bondable

    @bondable.setter
    def bondable(self, bondable):
        """Sets the bondable of this Pool.

        whether LPs can bond liquidity in the pool to a node  # noqa: E501

        :param bondable: The bondable of this Pool.  # noqa: E501
        :type: bool
        """
        if bondable is None:
            raise ValueError("Invalid value for `bondable`, must not be `None`")  # noqa: E501
