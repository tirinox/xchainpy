...
class Pool(object):
    ...
    def __init__(self, balance_cacao=None, balance_asset=None, asset=None, lp_units=None, pool_units=None, status=None, decimals=None, synth_units=None, synth_supply=None, pending_inbound_cacao=None, pending_inbound_asset=None):  # noqa: E501
