...
class TxOutItem(object):
    ...
    def __init__(self, chain=None, to_address=None, vault_pub_key=None, coin=None, memo=None, max_gas=None, gas_rate=None, in_hash=None, out_hash=None, aggregator=None, aggregator_target_asset=None, aggregator_target_limit=None, height=None):  # noqa: E501
