...
class TxOutItem(object):
    ...
    def __init__(self, chain=None, to_address=None, vault_pub_key=None, vault_pub_key_eddsa=None, coin=None, memo=None, max_gas=None, gas_rate=None, in_hash=None, out_hash=None, aggregator=None, aggregator_target_asset=None, aggregator_target_limit=None, height=None, clout_spent=None):  # noqa: E501
    ...
    def aggregator(self):
        ...
        the contract address if an aggregator is specified for a non-mayachain SwapOut  # noqa: E501
    ...
    def aggregator_target_limit(self):
        ...
        the minimum amount of SwapOut asset to receive (else cancelling the SwapOut and receiving mayachain's output)  # noqa: E501
    ...
    def clout_spent(self):
        ...
        clout spent in CACAO for the outbound  # noqa: E501
