...
class Node(object):
    ...
    def __init__(self, node_address=None, status=None, pub_key_set=None, aztec_address=None, validator_cons_pub_key=None, peer_id=None, bond=None, reward=None, active_block_height=None, bond_address=None, status_since=None, signer_membership=None, requested_to_leave=None, forced_to_leave=None, leave_height=None, ip_address=None, version=None, slash_points=None, jail=None, observe_chains=None, preflight_status=None, bond_providers=None):  # noqa: E501
        """Node - a model defined in Swagger"""  # noqa: E501
        self._node_address = None
        self._status = None
        self._pub_key_set = None
        self._aztec_address = None
        ...
        self.aztec_address = aztec_address
    ...
    @property
    def aztec_address(self):
        """Gets the aztec_address of this Node.  # noqa: E501


        :return: The aztec_address of this Node.  # noqa: E501
        :rtype: str
        """
        return self._aztec_address

    @aztec_address.setter
    def aztec_address(self, aztec_address):
        """Sets the aztec_address of this Node.


        :param aztec_address: The aztec_address of this Node.  # noqa: E501
        :type: str
        """
        if aztec_address is None:
            raise ValueError("Invalid value for `aztec_address`, must not be `None`")  # noqa: E501

        self._aztec_address = aztec_address
    ...
    @property
    def reward(self):
        """Gets the reward of this Node.  # noqa: E501


        :return: The reward of this Node.  # noqa: E501
        :rtype: str
        """
        return self._reward
    ...
    def reward(self, reward):
        """Sets the reward of this Node.


        :param reward: The reward of this Node.  # noqa: E501
        :type: str
        """
        if reward is None:
