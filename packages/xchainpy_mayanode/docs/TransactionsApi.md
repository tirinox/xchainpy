...
[**tx_in_voter**](TransactionsApi.md#tx_in_voter) | **GET** /mayachain/tx/in/{hash} | 
[**tx_out_voter**](TransactionsApi.md#tx_out_voter) | **GET** /mayachain/tx/out/{hash} | 
...
# **tx_in_voter**
> TxDetailsResponse tx_in_voter(hash, height=height)



Returns the inbound transaction voter for a provided hash.
...
try:
    api_response = api_instance.tx_in_voter(hash, height=height)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling TransactionsApi->tx_in_voter: %s\n" % e)
```
...
# **tx_out_voter**
> TxDetailsResponse tx_out_voter(hash, height=height)



Returns the outbound transaction voter for a provided hash.
...
try:
    api_response = api_instance.tx_out_voter(hash, height=height)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling TransactionsApi->tx_out_voter: %s\n" % e)
```
