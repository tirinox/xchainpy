...
@pytest.mark.parametrize('coin, amount', [
    (Coin(124, 'cacao'), CryptoAmount(Amount.auto_base(124, CACAO_DECIMAL), AssetCACAO)),
    (Coin(778899, 'maya'), CryptoAmount(Amount.auto_base(778899, MAYA_DECIMAL), AssetMAYA)),
    (Coin(123455, 'thor/rune'), CryptoAmount(Amount.auto_base(123455, RUNE_DECIMAL), AssetRUNE.as_synth))
])
