...
**asset_slashed** | **str** | Int64(e8), total asset slashed from the member | 
**asset_withdrawn** | **str** | Int64(e8), total asset withdrawn from the pool by member | 
**cacao_deposit** | **str** | Int64(e8), total Cacao that is currently deposited to the pool by member. This field is same as the &#x60;rune_deposit_value&#x60; field in thornode. Mainly can be used  for tracking, mainly Growth Percentage  | 
**cacao_slashed** | **str** | Int64(e10), total Cacao slashed from the member | 
