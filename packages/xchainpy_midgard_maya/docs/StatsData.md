...
**cacao_price_usd** | **str** | Float, the price of Cacao based on the deepest USD pool. | 
**daily_active_users** | **str** | Int64, number of unique users who made a swap in the last 24h. | 
**impermanent_loss_protection_paid** | **str** | Int64(e8), impermanent loss protection paid out.  | 
**monthly_active_users** | **str** | Int64, number of unique users who made a swap in the last 30d. | 
...
**unique_swapper_count** | **str** | Int64, number of unique users who made a swap since beginning. | 
