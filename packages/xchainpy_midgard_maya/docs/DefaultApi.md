# xchainpy2_midgard_maya.DefaultApi
...
[**get_cacao_pool_detail**](DefaultApi.md#get_cacao_pool_detail) | **GET** /v2/cacaopool/{address} | CACAOPool Details
[**get_cacao_pool_history**](DefaultApi.md#get_cacao_pool_history) | **GET** /v2/history/cacaopool | CacaoPool total members and units History
[**get_cacao_price_history**](DefaultApi.md#get_cacao_price_history) | **GET** /v2/history/cacao | Cacao price history in USD
...
[**get_thor_name_detail**](DefaultApi.md#get_thor_name_detail) | **GET** /v2/mayaname/lookup/{name} | THORName Details
...
type = 'type_example' # str | One or more comma separated unique types of action (swap, addLiquidity, withdraw, donate, refund, switch, mayaname, cacaoPoolDeposit, cacaoPoolWithdraw)  (optional)
 ...
 **type** | **str**| One or more comma separated unique types of action (swap, addLiquidity, withdraw, donate, refund, switch, mayaname, cacaoPoolDeposit, cacaoPoolWithdraw)  | [optional] 
...
# **get_cacao_pool_detail**
> list[CACAOPoolProvider] get_cacao_pool_detail(address)
...
# create an instance of the API class
api_instance = xchainpy2_midgard_maya.DefaultApi()
address = 'address_example' # str | Address to match the CACAOPool. multiple cacao addresses can be given. 

try:
    # CACAOPool Details
    api_response = api_instance.get_cacao_pool_detail(address)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->get_cacao_pool_detail: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **address** | **str**| Address to match the CACAOPool. multiple cacao addresses can be given.  | 

### Return type

[**list[CACAOPoolProvider]**](CACAOPoolProvider.md)
...
# **get_cacao_pool_history**
> CACAOPoolHistory get_cacao_pool_history(interval=interval, count=count, to=to, _from=_from)

CacaoPool total members and units History
...
try:
    # CacaoPool total members and units History
    api_response = api_instance.get_cacao_pool_history(interval=interval, count=count, to=to, _from=_from)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->get_cacao_pool_history: %s\n" % e)
```
...
[**CACAOPoolHistory**](CACAOPoolHistory.md)
...
# **get_cacao_price_history**
> CacaoPriceHistory get_cacao_price_history(interval=interval, count=count, to=to, _from=_from)

Cacao price history in USD
...
try:
    # Cacao price history in USD
    api_response = api_instance.get_cacao_price_history(interval=interval, count=count, to=to, _from=_from)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->get_cacao_price_history: %s\n" % e)
```
...
[**CacaoPriceHistory**](CacaoPriceHistory.md)
