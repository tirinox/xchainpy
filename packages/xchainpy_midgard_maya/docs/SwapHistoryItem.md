...
**cacao_price_usd** | **str** | Float, the price of Cacao based on the deepest USD pool at the end of the interval.  | 
...
**from_trade_fees** | **str** | Int64(e8), the fees collected from swaps from trade asset to rune (in rune) | 
**from_trade_volume** | **str** | Int64(e8), volume of swaps from trade asset to rune denoted in rune | 
...
**to_trade_volume** | **str** | Int64(e8), volume of swaps from rune to trade denoted in rune | 
