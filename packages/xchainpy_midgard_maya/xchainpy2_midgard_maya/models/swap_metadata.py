...
class SwapMetadata(object):
    ...
    def __init__(self, affiliate_address=None, affiliate_fee=None, in_price_usd=None, is_streaming_swap=None, liquidity_fee=None, memo=None, network_fees=None, out_price_usd=None, streaming_swap_meta=None, swap_slip=None, swap_target=None):  # noqa: E501
