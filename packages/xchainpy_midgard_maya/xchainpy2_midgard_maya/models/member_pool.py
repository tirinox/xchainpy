...
class MemberPool(object):
    ...
    def __init__(self, asset_added=None, asset_address=None, asset_deposit=None, asset_pending=None, asset_slashed=None, asset_withdrawn=None, cacao_deposit=None, cacao_slashed=None, date_first_added=None, date_last_added=None, liquidity_units=None, pool=None, rune_added=None, rune_address=None, rune_pending=None, rune_withdrawn=None):  # noqa: E501
    ...
    @property
    def asset_slashed(self):
        """Gets the asset_slashed of this MemberPool.  # noqa: E501

        Int64(e8), total asset slashed from the member  # noqa: E501

        :return: The asset_slashed of this MemberPool.  # noqa: E501
        :rtype: str
        """
        return self._asset_slashed

    @asset_slashed.setter
    def asset_slashed(self, asset_slashed):
        """Sets the asset_slashed of this MemberPool.

        Int64(e8), total asset slashed from the member  # noqa: E501

        :param asset_slashed: The asset_slashed of this MemberPool.  # noqa: E501
        :type: str
        """
        if asset_slashed is None:
            raise ValueError("Invalid value for `asset_slashed`, must not be `None`")  # noqa: E501

        self._asset_slashed = asset_slashed
    ...
    def cacao_deposit(self):
        """Gets the cacao_deposit of this MemberPool.  # noqa: E501

        Int64(e8), total Cacao that is currently deposited to the pool by member. This field is same as the `rune_deposit_value` field in thornode. Mainly can be used  for tracking, mainly Growth Percentage   # noqa: E501

        :return: The cacao_deposit of this MemberPool.  # noqa: E501
        :rtype: str
        """
    ...
    def cacao_deposit(self, cacao_deposit):
        """Sets the cacao_deposit of this MemberPool.

        Int64(e8), total Cacao that is currently deposited to the pool by member. This field is same as the `rune_deposit_value` field in thornode. Mainly can be used  for tracking, mainly Growth Percentage   # noqa: E501

        :param cacao_deposit: The cacao_deposit of this MemberPool.  # noqa: E501
        :type: str
        """
    ...
    @property
    def cacao_slashed(self):
        """Gets the cacao_slashed of this MemberPool.  # noqa: E501

        Int64(e10), total Cacao slashed from the member  # noqa: E501

        :return: The cacao_slashed of this MemberPool.  # noqa: E501
        :rtype: str
        """
        return self._cacao_slashed

    @cacao_slashed.setter
    def cacao_slashed(self, cacao_slashed):
        """Sets the cacao_slashed of this MemberPool.

        Int64(e10), total Cacao slashed from the member  # noqa: E501

        :param cacao_slashed: The cacao_slashed of this MemberPool.  # noqa: E501
        :type: str
        """
        if cacao_slashed is None:
            raise ValueError("Invalid value for `cacao_slashed`, must not be `None`")  # noqa: E501

        self._cacao_slashed = cacao_slashed
