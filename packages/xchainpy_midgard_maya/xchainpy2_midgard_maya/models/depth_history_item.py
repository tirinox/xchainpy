...
class DepthHistoryItem(object):
    ...
    def __init__(self, asset_depth=None, asset_price=None, asset_price_usd=None, end_time=None, liquidity_units=None, luvi=None, members_count=None, ohlc=None, rune_depth=None, start_time=None, synth_supply=None, synth_units=None, units=None):  # noqa: E501
    ...
    @property
    def ohlc(self):
        """Gets the ohlc of this DepthHistoryItem.  # noqa: E501

        Array of 4 float values representing the Open, High, Low, Close prices of the asset in usd in the given time interval. The values are in the order of Open, High, Low, Close.   # noqa: E501

        :return: The ohlc of this DepthHistoryItem.  # noqa: E501
        :rtype: list[str]
        """
        return self._ohlc
    ...
    @ohlc.setter
    def ohlc(self, ohlc):
        """Sets the ohlc of this DepthHistoryItem.

        Array of 4 float values representing the Open, High, Low, Close prices of the asset in usd in the given time interval. The values are in the order of Open, High, Low, Close.   # noqa: E501

        :param ohlc: The ohlc of this DepthHistoryItem.  # noqa: E501
        :type: list[str]
        """
        if ohlc is None:
            raise ValueError("Invalid value for `ohlc`, must not be `None`")  # noqa: E501
