...
class DefaultApi(object):
    ...
    def get_actions(self, **kwargs):  # noqa: E501
        ...
        :param str type: One or more comma separated unique types of action (swap, addLiquidity, withdraw, donate, refund, switch, mayaname, cacaoPoolDeposit, cacaoPoolWithdraw) 
    ...
    def get_actions_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['address', 'txid', 'asset', 'type', 'affiliate', 'limit', 'offset', 'next_page_token', 'timestamp', 'height', 'prev_page_token', 'from_timestamp', 'from_height']  # noqa: E501
    ...
    def get_affiliate_history(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str mayaname: Return history given mayaname. Returns sum of all mayanames if missing.
    ...
    def get_affiliate_history_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['mayaname', 'interval', 'count', 'to', '_from']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        query_params = []
        if 'mayaname' in params:
            query_params.append(('mayaname', params['mayaname']))  # noqa: E501
    ...
    def get_borrower_detail(self, address, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str address: Address to match borrower, an asset address is given. Query can also be multiple addresses should be seperated by comma (',')  (required)
    ...
    def get_cacao_pool_detail(self, address, **kwargs):  # noqa: E501
        """CACAOPool Details  # noqa: E501

        Returns an array of statistics for all the CACAOPool associated with given member addresses. Query can also be multiple addresses should be separated by comma (',')   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_cacao_pool_detail(address, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str address: Address to match the CACAOPool. multiple cacao addresses can be given.  (required)
        :return: list[CACAOPoolProvider]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_cacao_pool_detail_with_http_info(address, **kwargs)  # noqa: E501
        else:
            (data) = self.get_cacao_pool_detail_with_http_info(address, **kwargs)  # noqa: E501
            return data

    def get_cacao_pool_detail_with_http_info(self, address, **kwargs):  # noqa: E501
        """CACAOPool Details  # noqa: E501

        Returns an array of statistics for all the CACAOPool associated with given member addresses. Query can also be multiple addresses should be separated by comma (',')   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_cacao_pool_detail_with_http_info(address, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_cacao_pool_detail" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'address' is set
        if ('address' not in params or
                params['address'] is None):
            raise ValueError("Missing the required parameter `address` when calling `get_cacao_pool_detail`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[CACAOPoolProvider]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_cacao_pool_history(self, **kwargs):  # noqa: E501
        """CacaoPool total members and units History  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_cacao_pool_history(async_req=True)
        >>> result = thread.get()
        ...
        :param int to: End time of the query as unix timestamp. If only count is given, defaults to now. 
        :param int _from: Start time of the query as unix timestamp
        :return: CACAOPoolHistory
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_cacao_pool_history_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_cacao_pool_history_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_cacao_pool_history_with_http_info(self, **kwargs):  # noqa: E501
        """CacaoPool total members and units History  # noqa: E501

        Returns CacaoPool members and units. The values report the state at the end of each interval.  History endpoint has two modes: * With Interval parameter it returns a series of time buckets. From and To dates will   be rounded to the Interval boundaries. * Without Interval parameter a single From..To search is performed with exact timestamps.   * Interval: possible values: 5min, hour, day, week, month, quarter, year. * count: [1..400]. Defines number of intervals. Don't provide if Interval is missing. * from/to: optional int, unix second.  Possible usages with interval. * last 10 days: `?interval=day&count=10` * last 10 days before to: `?interval=day&count=10&to=1608825600` * next 10 days after from: `?interval=day&count=10&from=1606780800` * Days between from and to. From defaults to start of chain, to defaults to now.   Only the first 400 intervals are returned:   `interval=day&from=1606780800&to=1608825600`  Pagination is possible with from&count and then using the returned meta.endTime as the From parameter of the next query.  Possible configurations without interval: * exact search for one time frame: `?from=1606780899&to=1608825600` * one time frame until now: `?from=1606780899` * from chain start until now: no query parameters   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_cacao_pool_history_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_cacao_pool_history" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='CACAOPoolHistory',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_cacao_price_history(self, **kwargs):  # noqa: E501
        """Cacao price history in USD  # noqa: E501

        Returns cacao price history in USD based on the time bucket given   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_cacao_price_history(async_req=True)
        >>> result = thread.get()
        ...
        :param int to: End time of the query as unix timestamp. If only count is given, defaults to now. 
        :param int _from: Start time of the query as unix timestamp
        :return: CacaoPriceHistory
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_cacao_price_history_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_cacao_price_history_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_cacao_price_history_with_http_info(self, **kwargs):  # noqa: E501
        """Cacao price history in USD  # noqa: E501

        Returns cacao price history in USD based on the time bucket given   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_cacao_price_history_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_cacao_price_history" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='CacaoPriceHistory',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_member_detail(self, address, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str address: Address to match liquidity providers. Either a rune or an asset address may be given. Query can also be multiple addresses should be seperated by comma (',')  (required)
    ...
    def get_saver_detail(self, address, **kwargs):  # noqa: E501
        ...
        Returns an array of statistics for all the savers associated with a given member address. Query can also be multiple addresses should be seperated by comma (',')   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_thor_names_by_address_with_http_info(self, address, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v2/mayaname/rlookup/{address}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_thor_names_owner_by_address(self, address, **kwargs):  # noqa: E501
        ...
        Returns an array of THORNames owned by the address. The address is not necessarily an associated address for those mayanames.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
