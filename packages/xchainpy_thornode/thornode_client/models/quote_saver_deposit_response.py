...
class QuoteSaverDepositResponse(object):
    ...
    def __init__(self, inbound_address=None, inbound_confirmation_blocks=None, inbound_confirmation_seconds=None, outbound_delay_blocks=None, outbound_delay_seconds=None, fees=None, slippage_bps=None, router=None, expiry=None, warning=None, notes=None, dust_threshold=None, memo=None, expected_amount_out=None, expected_amount_deposit=None):  # noqa: E501
        ...
        if expected_amount_deposit is not None:
    ...
    def expected_amount_out(self):
        ...
        migrate to expected_amount_deposit (will be deprecated in v1.104)  # noqa: E501
