...
api_instance = xchainpy2_thornode.BorrowersApi(xchainpy2_thornode.ApiClient(configuration))
...
*TransactionsApi* | [**tx_stages**](docs/TransactionsApi.md#tx_stages) | **GET** /thorchain/alpha/tx/stages/{hash} | 
*TransactionsApi* | [**tx_status**](docs/TransactionsApi.md#tx_status) | **GET** /thorchain/alpha/tx/status/{hash} | 
