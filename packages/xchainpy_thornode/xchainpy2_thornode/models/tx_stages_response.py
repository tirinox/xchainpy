...
class TxStagesResponse(object):
    ...
    def __init__(self, inbound_observed=None, inbound_confirmation_counted=None, inbound_finalised=None, swap_finalised=None, outbound_delay=None, outbound_signed=None):  # noqa: E501
    ...
    def inbound_finalised(self, inbound_finalised):
        ...
        """
        if inbound_finalised is None:
            raise ValueError("Invalid value for `inbound_finalised`, must not be `None`")  # noqa: E501
