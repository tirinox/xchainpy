...
class Node(object):
    ...
    swagger_types = {
        ...
        'jail': 'NodeJail',
        'current_award': 'str',
        'observe_chains': 'list[ChainHeight]',
        'maintenance': 'bool',
        'missing_blocks': 'int',
    ...
    def __init__(self, node_address=None, status=None, pub_key_set=None, validator_cons_pub_key=None, peer_id=None, active_block_height=None, status_since=None, node_operator_address=None, total_bond=None, bond_providers=None, signer_membership=None, requested_to_leave=None, forced_to_leave=None, leave_height=None, ip_address=None, version=None, slash_points=None, jail=None, current_award=None, observe_chains=None, maintenance=None, missing_blocks=None, preflight_status=None):  # noqa: E501
        ...
        self._node_operator_address = None
        self._total_bond = None
        self._bond_providers = None
        ...
        self.node_operator_address = node_operator_address
        self.total_bond = total_bond
        self.bond_providers = bond_providers
    ...
    def status(self, status):
        ...
        allowed_values = ["Active", "Whitelisted", "Standby", "Disabled"]  # noqa: E501
    ...
    def validator_cons_pub_key(self):
        ...
        the consensus pub key for the node  # noqa: E501
    ...
    @property
    def peer_id(self):
        """Gets the peer_id of this Node.  # noqa: E501

        the P2PID (:6040/p2pid endpoint) of the node  # noqa: E501

        :return: The peer_id of this Node.  # noqa: E501
        :rtype: str
        """
    ...
    def peer_id(self, peer_id):
        """Sets the peer_id of this Node.

        the P2PID (:6040/p2pid endpoint) of the node  # noqa: E501

        :param peer_id: The peer_id of this Node.  # noqa: E501
        :type: str
        """
        if peer_id is None:
    ...
    def active_block_height(self):
        ...
        the block height at which the node became active  # noqa: E501
    ...
    def status_since(self):
        ...
        the block height of the current provided information for the node  # noqa: E501
    ...
    @property
    def node_operator_address(self):
        """Gets the node_operator_address of this Node.  # noqa: E501


        :return: The node_operator_address of this Node.  # noqa: E501
        :rtype: str
        """
        return self._node_operator_address

    @node_operator_address.setter
    def node_operator_address(self, node_operator_address):
        """Sets the node_operator_address of this Node.


        :param node_operator_address: The node_operator_address of this Node.  # noqa: E501
        :type: str
        """
        if node_operator_address is None:
            raise ValueError("Invalid value for `node_operator_address`, must not be `None`")  # noqa: E501

        self._node_operator_address = node_operator_address

    @property
    def total_bond(self):
        """Gets the total_bond of this Node.  # noqa: E501

        current node bond  # noqa: E501

        :return: The total_bond of this Node.  # noqa: E501
        :rtype: str
        """
        return self._total_bond

    @total_bond.setter
    def total_bond(self, total_bond):
        """Sets the total_bond of this Node.

        current node bond  # noqa: E501

        :param total_bond: The total_bond of this Node.  # noqa: E501
        :type: str
        """
        if total_bond is None:
            raise ValueError("Invalid value for `total_bond`, must not be `None`")  # noqa: E501

        self._total_bond = total_bond

    @property
    def bond_providers(self):
        """Gets the bond_providers of this Node.  # noqa: E501


        :return: The bond_providers of this Node.  # noqa: E501
        :rtype: NodeBondProviders
        """
        return self._bond_providers

    @bond_providers.setter
    def bond_providers(self, bond_providers):
        """Sets the bond_providers of this Node.


        :param bond_providers: The bond_providers of this Node.  # noqa: E501
        :type: NodeBondProviders
        """
        if bond_providers is None:
            raise ValueError("Invalid value for `bond_providers`, must not be `None`")  # noqa: E501

        self._bond_providers = bond_providers

    @property
    def signer_membership(self):
        """Gets the signer_membership of this Node.  # noqa: E501

        the set of vault public keys of which the node is a member  # noqa: E501
    ...
    def forced_to_leave(self):
        ...
        indicates whether the node has been forced to leave by the network, typically via ban  # noqa: E501
    ...
    def leave_height(self):
        """Gets the leave_height of this Node.  # noqa: E501


        :return: The leave_height of this Node.  # noqa: E501
        :rtype: int
        """
    ...
    def leave_height(self, leave_height):
        """Sets the leave_height of this Node.


        :param leave_height: The leave_height of this Node.  # noqa: E501
        :type: int
        """
    ...
    def version(self):
        ...
        the currently set version of the node  # noqa: E501
    ...
    def slash_points(self):
        ...
        the accumulated slash points, reset at churn but excessive slash points may carry over  # noqa: E501
    ...
    def observe_chains(self):
        ...
        the last observed heights for all chain by the node  # noqa: E501

        :return: The observe_chains of this Node.  # noqa: E501
        :rtype: list[ChainHeight]
        """
    ...
    def maintenance(self):
        """Gets the maintenance of this Node.  # noqa: E501

        indicates whether the node is in maintenance mode  # noqa: E501

        :return: The maintenance of this Node.  # noqa: E501
        :rtype: bool
        """
    ...
    def maintenance(self, maintenance):
        """Sets the maintenance of this Node.

        indicates whether the node is in maintenance mode  # noqa: E501

        :param maintenance: The maintenance of this Node.  # noqa: E501
        :type: bool
        """
    ...
    def missing_blocks(self):
        """Gets the missing_blocks of this Node.  # noqa: E501

        the number of recent blocks the node has missed signing  # noqa: E501

        :return: The missing_blocks of this Node.  # noqa: E501
        :rtype: int
        """
    ...
    def missing_blocks(self, missing_blocks):
        """Sets the missing_blocks of this Node.

        the number of recent blocks the node has missed signing  # noqa: E501

        :param missing_blocks: The missing_blocks of this Node.  # noqa: E501
        :type: int
        """
        if missing_blocks is None:
            raise ValueError("Invalid value for `missing_blocks`, must not be `None`")  # noqa: E501
