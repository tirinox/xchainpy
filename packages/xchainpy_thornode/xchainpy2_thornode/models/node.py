...
class Node(object):
    ...
    def __init__(self, node_address=None, status=None, pub_key_set=None, validator_cons_pub_key=None, peer_id=None, active_block_height=None, status_since=None, node_operator_address=None, total_bond=None, bond_providers=None, signer_membership=None, requested_to_leave=None, forced_to_leave=None, leave_height=None, ip_address=None, version=None, slash_points=None, jail=None, current_award=None, observe_chains=None, preflight_status=None):  # noqa: E501
