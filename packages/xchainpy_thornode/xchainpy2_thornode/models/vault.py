...
class Vault(object):
    ...
    def __init__(self, block_height=None, pub_key=None, coins=None, type=None, status=None, status_since=None, membership=None, chains=None, inbound_tx_count=None, outbound_tx_count=None, pending_tx_block_heights=None, routers=None, addresses=None):  # noqa: E501
