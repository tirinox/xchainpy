...
class TxOutItem(object):
    ...
    attribute_map = {
        ...
        'vault_pub_key_eddsa': 'vault_pub_key_eddsa',
        'coin': 'coin',
        'max_gas': 'max_gas',
        'gas_rate': 'gas_rate',
        'memo': 'memo',
        ...
        'aggregator_target_asset': 'aggregator_target_asset',
        'aggregator_target_limit': 'aggregator_target_limit',
        'clout_spent': 'clout_spent'
    }

    def __init__(self, height=None, in_hash=None, out_hash=None, chain=None, to_address=None, vault_pub_key=None, vault_pub_key_eddsa=None, coin=None, max_gas=None, gas_rate=None, memo=None, original_memo=None, aggregator=None, aggregator_target_asset=None, aggregator_target_limit=None, clout_spent=None):  # noqa: E501
        ...
        self._vault_pub_key_eddsa = None
        self._coin = None
        self._max_gas = None
        self._gas_rate = None
        self._memo = None
        self._original_memo = None
        self._aggregator = None
        self._aggregator_target_asset = None
        ...
        if vault_pub_key_eddsa is not None:
            self.vault_pub_key_eddsa = vault_pub_key_eddsa
        self.coin = coin
        ...
        if aggregator_target_asset is not None:
            self.aggregator_target_asset = aggregator_target_asset
    ...
    @property
    def vault_pub_key_eddsa(self):
        """Gets the vault_pub_key_eddsa of this TxOutItem.  # noqa: E501


        :return: The vault_pub_key_eddsa of this TxOutItem.  # noqa: E501
        :rtype: str
        """
        return self._vault_pub_key_eddsa

    @vault_pub_key_eddsa.setter
    def vault_pub_key_eddsa(self, vault_pub_key_eddsa):
        """Sets the vault_pub_key_eddsa of this TxOutItem.


        :param vault_pub_key_eddsa: The vault_pub_key_eddsa of this TxOutItem.  # noqa: E501
        :type: str
        """

        self._vault_pub_key_eddsa = vault_pub_key_eddsa
    ...
    @property
    def original_memo(self):
        """Gets the original_memo of this TxOutItem.  # noqa: E501


        :return: The original_memo of this TxOutItem.  # noqa: E501
        :rtype: str
        """
        return self._original_memo

    @original_memo.setter
    def original_memo(self, original_memo):
        """Sets the original_memo of this TxOutItem.


        :param original_memo: The original_memo of this TxOutItem.  # noqa: E501
        :type: str
        """

        self._original_memo = original_memo

    @property
    def aggregator(self):
        """Gets the aggregator of this TxOutItem.  # noqa: E501

        whitelisted DEX Aggregator contract address  # noqa: E501

        :return: The aggregator of this TxOutItem.  # noqa: E501
        :rtype: str
        """
    ...
    def aggregator(self, aggregator):
        """Sets the aggregator of this TxOutItem.

        whitelisted DEX Aggregator contract address  # noqa: E501

        :param aggregator: The aggregator of this TxOutItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def aggregator_target_asset(self):
        """Gets the aggregator_target_asset of this TxOutItem.  # noqa: E501

        target asset for the aggregator contract to attempt a swap to  # noqa: E501

        :return: The aggregator_target_asset of this TxOutItem.  # noqa: E501
        :rtype: str
        """
        return self._aggregator_target_asset

    @aggregator_target_asset.setter
    def aggregator_target_asset(self, aggregator_target_asset):
        """Sets the aggregator_target_asset of this TxOutItem.

        target asset for the aggregator contract to attempt a swap to  # noqa: E501

        :param aggregator_target_asset: The aggregator_target_asset of this TxOutItem.  # noqa: E501
        :type: str
        """

        self._aggregator_target_asset = aggregator_target_asset

    @property
    def aggregator_target_limit(self):
        """Gets the aggregator_target_limit of this TxOutItem.  # noqa: E501

        the minimum number of tokens the swapper wants to receive of the output asset  # noqa: E501

        :return: The aggregator_target_limit of this TxOutItem.  # noqa: E501
        :rtype: str
        """
    ...
    def aggregator_target_limit(self, aggregator_target_limit):
        """Sets the aggregator_target_limit of this TxOutItem.

        the minimum number of tokens the swapper wants to receive of the output asset  # noqa: E501

        :param aggregator_target_limit: The aggregator_target_limit of this TxOutItem.  # noqa: E501
        :type: str
        """
