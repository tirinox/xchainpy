...
class TxOutItem(object):
    ...
    def __init__(self, height=None, vault_pub_key=None, in_hash=None, out_hash=None, chain=None, to_address=None, coin=None, max_gas=None, gas_rate=None, memo=None, aggregator=None, aggregator_target_asset=None, aggregator_target_limit=None, clout_spent=None):  # noqa: E501
