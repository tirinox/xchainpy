...
class StreamingSwap(object):
    ...
    def __init__(self, tx_id=None, interval=None, quantity=None, count=None, last_height=None, trade_target=None, deposit=None, _in=None, out=None, failed_swaps=None, failed_swap_reasons=None):  # noqa: E501
