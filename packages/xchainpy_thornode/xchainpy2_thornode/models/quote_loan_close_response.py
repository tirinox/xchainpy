...
class QuoteLoanCloseResponse(object):
    ...
    swagger_types = {
        ...
        'expected_collateral_down': 'str',
        'expected_debt_down': 'str'
    }
    ...
    attribute_map = {
        ...
        'expected_collateral_down': 'expected_collateral_down',
        'expected_debt_down': 'expected_debt_down'
    }

    def __init__(self, inbound_address=None, inbound_confirmation_blocks=None, inbound_confirmation_seconds=None, outbound_delay_blocks=None, outbound_delay_seconds=None, fees=None, slippage_bps=None, router=None, expiry=None, warning=None, notes=None, dust_threshold=None, recommended_min_amount_in=None, memo=None, expected_amount_out=None, expected_collateral_down=None, expected_debt_down=None):  # noqa: E501
        ...
        self._expected_collateral_down = None
        self._expected_debt_down = None
        ...
        self.expected_collateral_down = expected_collateral_down
        self.expected_debt_down = expected_debt_down
    ...
    def slippage_bps(self):
        """Gets the slippage_bps of this QuoteLoanCloseResponse.  # noqa: E501

        the total swap slippage in basis points  # noqa: E501

        :return: The slippage_bps of this QuoteLoanCloseResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def slippage_bps(self, slippage_bps):
        """Sets the slippage_bps of this QuoteLoanCloseResponse.

        the total swap slippage in basis points  # noqa: E501

        :param slippage_bps: The slippage_bps of this QuoteLoanCloseResponse.  # noqa: E501
        :type: int
        """
    ...
    @property
    def expected_collateral_down(self):
        """Gets the expected_collateral_down of this QuoteLoanCloseResponse.  # noqa: E501

        the expected amount of collateral decrease on the loan  # noqa: E501

        :return: The expected_collateral_down of this QuoteLoanCloseResponse.  # noqa: E501
        :rtype: str
        """
        return self._expected_collateral_down

    @expected_collateral_down.setter
    def expected_collateral_down(self, expected_collateral_down):
        """Sets the expected_collateral_down of this QuoteLoanCloseResponse.

        the expected amount of collateral decrease on the loan  # noqa: E501

        :param expected_collateral_down: The expected_collateral_down of this QuoteLoanCloseResponse.  # noqa: E501
        :type: str
        """
        if expected_collateral_down is None:
            raise ValueError("Invalid value for `expected_collateral_down`, must not be `None`")  # noqa: E501

        self._expected_collateral_down = expected_collateral_down

    @property
    def expected_debt_down(self):
        """Gets the expected_debt_down of this QuoteLoanCloseResponse.  # noqa: E501

        the expected amount of TOR debt decrease on the loan  # noqa: E501

        :return: The expected_debt_down of this QuoteLoanCloseResponse.  # noqa: E501
        :rtype: str
        """
        return self._expected_debt_down

    @expected_debt_down.setter
    def expected_debt_down(self, expected_debt_down):
        """Sets the expected_debt_down of this QuoteLoanCloseResponse.

        the expected amount of TOR debt decrease on the loan  # noqa: E501

        :param expected_debt_down: The expected_debt_down of this QuoteLoanCloseResponse.  # noqa: E501
        :type: str
        """
        if expected_debt_down is None:
            raise ValueError("Invalid value for `expected_debt_down`, must not be `None`")  # noqa: E501

        self._expected_debt_down = expected_debt_down
