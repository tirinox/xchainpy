...
class QuoteLoanOpenResponse(object):
    ...
    def __init__(self, inbound_address=None, inbound_confirmation_blocks=None, inbound_confirmation_seconds=None, outbound_delay_blocks=None, outbound_delay_seconds=None, fees=None, slippage_bps=None, router=None, expiry=None, warning=None, notes=None, dust_threshold=None, memo=None, expected_amount_out=None, expected_collateralization_ratio=None, expected_collateral_up=None, expected_debt_up=None):  # noqa: E501
