...
class QuoteLoanOpenResponse(object):
    ...
    swagger_types = {
        ...
        'expected_collateral_up': 'str',
        'expected_debt_up': 'str'
    }
    ...
    attribute_map = {
        ...
        'expected_collateral_up': 'expected_collateral_up',
        'expected_debt_up': 'expected_debt_up'
    }

    def __init__(self, inbound_address=None, inbound_confirmation_blocks=None, inbound_confirmation_seconds=None, outbound_delay_blocks=None, outbound_delay_seconds=None, fees=None, slippage_bps=None, router=None, expiry=None, warning=None, notes=None, dust_threshold=None, recommended_min_amount_in=None, memo=None, expected_amount_out=None, expected_collateralization_ratio=None, expected_collateral_up=None, expected_debt_up=None):  # noqa: E501
        ...
        self._expected_collateral_up = None
        self._expected_debt_up = None
        ...
        self.expected_collateral_up = expected_collateral_up
        self.expected_debt_up = expected_debt_up
    ...
    def slippage_bps(self):
        """Gets the slippage_bps of this QuoteLoanOpenResponse.  # noqa: E501

        the total swap slippage in basis points  # noqa: E501

        :return: The slippage_bps of this QuoteLoanOpenResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def slippage_bps(self, slippage_bps):
        """Sets the slippage_bps of this QuoteLoanOpenResponse.

        the total swap slippage in basis points  # noqa: E501

        :param slippage_bps: The slippage_bps of this QuoteLoanOpenResponse.  # noqa: E501
        :type: int
        """
    ...
    @property
    def expected_collateral_up(self):
        """Gets the expected_collateral_up of this QuoteLoanOpenResponse.  # noqa: E501

        the expected amount of collateral increase on the loan  # noqa: E501

        :return: The expected_collateral_up of this QuoteLoanOpenResponse.  # noqa: E501
        :rtype: str
        """
        return self._expected_collateral_up

    @expected_collateral_up.setter
    def expected_collateral_up(self, expected_collateral_up):
        """Sets the expected_collateral_up of this QuoteLoanOpenResponse.

        the expected amount of collateral increase on the loan  # noqa: E501

        :param expected_collateral_up: The expected_collateral_up of this QuoteLoanOpenResponse.  # noqa: E501
        :type: str
        """
        if expected_collateral_up is None:
            raise ValueError("Invalid value for `expected_collateral_up`, must not be `None`")  # noqa: E501

        self._expected_collateral_up = expected_collateral_up

    @property
    def expected_debt_up(self):
        """Gets the expected_debt_up of this QuoteLoanOpenResponse.  # noqa: E501

        the expected amount of TOR debt increase on the loan  # noqa: E501

        :return: The expected_debt_up of this QuoteLoanOpenResponse.  # noqa: E501
        :rtype: str
        """
        return self._expected_debt_up

    @expected_debt_up.setter
    def expected_debt_up(self, expected_debt_up):
        """Sets the expected_debt_up of this QuoteLoanOpenResponse.

        the expected amount of TOR debt increase on the loan  # noqa: E501

        :param expected_debt_up: The expected_debt_up of this QuoteLoanOpenResponse.  # noqa: E501
        :type: str
        """
        if expected_debt_up is None:
            raise ValueError("Invalid value for `expected_debt_up`, must not be `None`")  # noqa: E501

        self._expected_debt_up = expected_debt_up
