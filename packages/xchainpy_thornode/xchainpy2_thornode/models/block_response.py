...
class BlockResponse(object):
    ...
    attribute_map = {
        'id': 'id',
        'header': 'header',
        'finalize_block_events': 'finalize_block_events',
        'begin_block_events': 'begin_block_events',
        'end_block_events': 'end_block_events',
        'txs': 'txs'
    }

    def __init__(self, id=None, header=None, finalize_block_events=None, begin_block_events=None, end_block_events=None, txs=None):  # noqa: E501
        """BlockResponse - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._header = None
        self._finalize_block_events = None
        ...
        self.id = id
        self.header = header
        self.finalize_block_events = finalize_block_events
    ...
    @property
    def finalize_block_events(self):
        """Gets the finalize_block_events of this BlockResponse.  # noqa: E501


        :return: The finalize_block_events of this BlockResponse.  # noqa: E501
        :rtype: list[dict(str, str)]
        """
        return self._finalize_block_events

    @finalize_block_events.setter
    def finalize_block_events(self, finalize_block_events):
        """Sets the finalize_block_events of this BlockResponse.


        :param finalize_block_events: The finalize_block_events of this BlockResponse.  # noqa: E501
        :type: list[dict(str, str)]
        """
        if finalize_block_events is None:
            raise ValueError("Invalid value for `finalize_block_events`, must not be `None`")  # noqa: E501

        self._finalize_block_events = finalize_block_events
