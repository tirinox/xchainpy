...
class NetworkResponse(object):
    ...
    def __init__(self, bond_reward_rune=None, total_bond_units=None, available_pools_rune=None, vaults_liquidity_rune=None, effective_security_bond=None, total_reserve=None, vaults_migrating=None, gas_spent_rune=None, gas_withheld_rune=None, outbound_fee_multiplier=None, native_outbound_fee_rune=None, native_tx_fee_rune=None, tns_register_fee_rune=None, tns_fee_per_block_rune=None, rune_price_in_tor=None, tor_price_in_rune=None, tor_price_halted=None):  # noqa: E501
        ...
        self.tor_price_halted = tor_price_halted
    ...
    @property
    def tor_price_halted(self):
        """Gets the tor_price_halted of this NetworkResponse.  # noqa: E501

        indicates if all anchor chains are halted (true), or at least one anchor chain is available (false)  # noqa: E501

        :return: The tor_price_halted of this NetworkResponse.  # noqa: E501
        :rtype: bool
        """
        return self._tor_price_halted

    @tor_price_halted.setter
    def tor_price_halted(self, tor_price_halted):
        """Sets the tor_price_halted of this NetworkResponse.

        indicates if all anchor chains are halted (true), or at least one anchor chain is available (false)  # noqa: E501

        :param tor_price_halted: The tor_price_halted of this NetworkResponse.  # noqa: E501
        :type: bool
        """
        if tor_price_halted is None:
            raise ValueError("Invalid value for `tor_price_halted`, must not be `None`")  # noqa: E501

        self._tor_price_halted = tor_price_halted
