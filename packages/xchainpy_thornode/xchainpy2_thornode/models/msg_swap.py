...
class MsgSwap(object):
    ...
    def __init__(self, tx=None, target_asset=None, destination=None, trade_target=None, affiliate_address=None, affiliate_basis_points=None, signer=None, aggregator=None, aggregator_target_address=None, aggregator_target_limit=None, order_type=None):  # noqa: E501
