...
class Pool(object):
    ...
    def __init__(self, balance_rune=None, balance_asset=None, asset=None, lp_units=None, pool_units=None, status=None, decimals=None, synth_units=None, synth_supply=None, pending_inbound_rune=None, pending_inbound_asset=None, savers_depth=None, savers_units=None, synth_mint_paused=None, synth_supply_remaining=None, loan_collateral=None):  # noqa: E501
