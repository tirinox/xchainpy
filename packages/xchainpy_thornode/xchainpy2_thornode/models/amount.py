...
class Amount(object):
    ...
    @property
    def denom(self):
        """Gets the denom of this Amount.  # noqa: E501


        :return: The denom of this Amount.  # noqa: E501
        :rtype: str
        """
        return self._denom
    ...
    def denom(self, denom):
        """Sets the denom of this Amount.


        :param denom: The denom of this Amount.  # noqa: E501
        :type: str
        """
        if denom is None:
            raise ValueError("Invalid value for `denom`, must not be `None`")  # noqa: E501
