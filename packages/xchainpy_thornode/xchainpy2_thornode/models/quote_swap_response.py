...
class QuoteSwapResponse(object):
    ...
    def streaming_slippage_bps(self):
        """Gets the streaming_slippage_bps of this QuoteSwapResponse.  # noqa: E501

        Deprecated - migrate to fees object.  # noqa: E501

        :return: The streaming_slippage_bps of this QuoteSwapResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def streaming_slippage_bps(self, streaming_slippage_bps):
        """Sets the streaming_slippage_bps of this QuoteSwapResponse.

        Deprecated - migrate to fees object.  # noqa: E501

        :param streaming_slippage_bps: The streaming_slippage_bps of this QuoteSwapResponse.  # noqa: E501
        :type: int
        """
        if streaming_slippage_bps is None:
            raise ValueError("Invalid value for `streaming_slippage_bps`, must not be `None`")  # noqa: E501
    ...
    @property
    def expected_amount_out_streaming(self):
        """Gets the expected_amount_out_streaming of this QuoteSwapResponse.  # noqa: E501

        Deprecated - expected_amount_out is streaming amount if interval provided.  # noqa: E501

        :return: The expected_amount_out_streaming of this QuoteSwapResponse.  # noqa: E501
        :rtype: str
        """
        return self._expected_amount_out_streaming

    @expected_amount_out_streaming.setter
    def expected_amount_out_streaming(self, expected_amount_out_streaming):
        """Sets the expected_amount_out_streaming of this QuoteSwapResponse.

        Deprecated - expected_amount_out is streaming amount if interval provided.  # noqa: E501

        :param expected_amount_out_streaming: The expected_amount_out_streaming of this QuoteSwapResponse.  # noqa: E501
        :type: str
        """
        if expected_amount_out_streaming is None:
            raise ValueError("Invalid value for `expected_amount_out_streaming`, must not be `None`")  # noqa: E501

        self._expected_amount_out_streaming = expected_amount_out_streaming

    @property
    def max_streaming_quantity(self):
        """Gets the max_streaming_quantity of this QuoteSwapResponse.  # noqa: E501

        the maxiumum amount of trades a streaming swap can do for a trade  # noqa: E501
