...
class MimirApi(object):
    ...
    def mimir_v2(self, **kwargs):  # noqa: E501
        """mimir_v2  # noqa: E501

        Returns current mimir V2 configuration.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.mimir_v2(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.mimir_v2_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.mimir_v2_with_http_info(**kwargs)  # noqa: E501
            return data

    def mimir_v2_with_http_info(self, **kwargs):  # noqa: E501
        """mimir_v2  # noqa: E501

        Returns current mimir V2 configuration.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.mimir_v2_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def mimir_v2_ids(self, **kwargs):  # noqa: E501
        """mimir_v2_ids  # noqa: E501

        Returns mapping of mimir V2 IDs to name.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.mimir_v2_ids(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.mimir_v2_ids_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.mimir_v2_ids_with_http_info(**kwargs)  # noqa: E501
            return data

    def mimir_v2_ids_with_http_info(self, **kwargs):  # noqa: E501
        """mimir_v2_ids  # noqa: E501

        Returns mapping of mimir V2 IDs to name.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.mimir_v2_ids_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='MimirV2IDsResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
