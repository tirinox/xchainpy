...
class QuoteApi(object):
    ...
    def quoteloanclose(self, **kwargs):  # noqa: E501
        ...
        :param str asset: the asset used to repay the loan
        :param int amount: the asset amount in 1e8 decimals
        :param str from_address: the address that is paying off the loan
        :param str loan_asset: the collateral asset of the loan
    ...
    def quoteloanclose_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['height', 'asset', 'amount', 'from_address', 'loan_asset', 'loan_owner', 'min_out']  # noqa: E501
        ...
        if 'loan_asset' in params:
            query_params.append(('loan_asset', params['loan_asset']))  # noqa: E501
    ...
    def quoteloanopen(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int height: optional block height, defaults to current tip
        :param str asset: the collateral asset
        :param int amount: the collateral asset amount in 1e8 decimals
        :param str target_asset: the target asset to receive (loan denominated in TOR regardless)
    ...
    def quoteloanopen_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['height', 'asset', 'amount', 'target_asset', 'destination', 'min_out', 'affiliate_bps', 'affiliate']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
