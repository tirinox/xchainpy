...
class QuoteApi(object):
    ...
    def quoteloanclose_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['height', 'from_asset', 'amount', 'to_asset', 'loan_owner', 'min_out']  # noqa: E501
    ...
    def quoteswap_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['height', 'from_asset', 'to_asset', 'amount', 'destination', 'streaming_interval', 'streaming_quantity', 'from_address', 'tolerance_bps', 'affiliate_bps', 'affiliate']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
