...
class VaultsApi(object):
    ...
    def vault_solvency(self, **kwargs):  # noqa: E501
        """vault_solvency  # noqa: E501

        Returns aggregate vault solvency showing over-solvent or under-solvent amounts per asset.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.vault_solvency(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.vault_solvency_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.vault_solvency_with_http_info(**kwargs)  # noqa: E501
            return data

    def vault_solvency_with_http_info(self, **kwargs):  # noqa: E501
        """vault_solvency  # noqa: E501

        Returns aggregate vault solvency showing over-solvent or under-solvent amounts per asset.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.vault_solvency_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='VaultSolvencyResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
