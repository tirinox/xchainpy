...
class QueueApi(object):
    ...
    def limit_swaps(self, **kwargs):  # noqa: E501
        """limit_swaps  # noqa: E501

        Returns limit swaps with pagination and filtering.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.limit_swaps(async_req=True)
        >>> result = thread.get()
        ...
        :param str source_asset: Filter by source asset (e.g., \"BTC.BTC\")
        :param str target_asset: Filter by target asset (e.g., \"ETH.ETH\")
        :param str sender: Filter by sender address
        ...
        if kwargs.get('async_req'):
            return self.limit_swaps_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.limit_swaps_with_http_info(**kwargs)  # noqa: E501
            return data

    def limit_swaps_with_http_info(self, **kwargs):  # noqa: E501
        """limit_swaps  # noqa: E501

        Returns limit swaps with pagination and filtering.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.limit_swaps_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['height', 'offset', 'limit', 'source_asset', 'target_asset', 'sender', 'sort_by', 'sort_order']  # noqa: E501
        ...
        if 'source_asset' in params:
            query_params.append(('source_asset', params['source_asset']))  # noqa: E501
        if 'target_asset' in params:
            query_params.append(('target_asset', params['target_asset']))  # noqa: E501
        if 'sender' in params:
        ...
        return self.api_client.call_api(
            '/thorchain/queue/limit_swaps', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='LimitSwapsResponse',  # noqa: E501
    ...
    def limit_swaps_summary(self, **kwargs):  # noqa: E501
        """limit_swaps_summary  # noqa: E501

        Returns limit swaps summary statistics.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.limit_swaps_summary(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.limit_swaps_summary_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.limit_swaps_summary_with_http_info(**kwargs)  # noqa: E501
            return data

    def limit_swaps_summary_with_http_info(self, **kwargs):  # noqa: E501
        """limit_swaps_summary  # noqa: E501

        Returns limit swaps summary statistics.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.limit_swaps_summary_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['height', 'source_asset', 'target_asset']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method limit_swaps_summary" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/thorchain/queue/limit_swaps/summary', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='LimitSwapsSummaryResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
