...
[**vault_solvency**](VaultsApi.md#vault_solvency) | **GET** /thorchain/vaults/solvency | 
...
# **vault_solvency**
> VaultSolvencyResponse vault_solvency(height=height)
...
try:
    api_response = api_instance.vault_solvency(height=height)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling VaultsApi->vault_solvency: %s\n" % e)
```
...
[**VaultSolvencyResponse**](VaultSolvencyResponse.md)
