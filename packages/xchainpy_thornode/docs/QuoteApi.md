...
api_instance = thornode_client.QuoteApi()
...
# **quoteloanopen**
> QuoteLoanOpenResponse quoteloanopen(height=height, asset=asset, amount=amount, target_asset=target_asset, destination=destination, min_out=min_out, affiliate_bps=affiliate_bps, affiliate=affiliate)
...
api_instance = thornode_client.QuoteApi()
height = 789 # int | optional block height, defaults to current tip (optional)
asset = 'asset_example' # str | the collateral asset (optional)
amount = 789 # int | the collateral asset amount in 1e8 decimals (optional)
target_asset = 'target_asset_example' # str | the target asset to receive (loan denominated in TOR regardless) (optional)
...
try:
    api_response = api_instance.quoteloanopen(height=height, asset=asset, amount=amount, target_asset=target_asset, destination=destination, min_out=min_out, affiliate_bps=affiliate_bps, affiliate=affiliate)
    pprint(api_response)
except ApiException as e:
...
------------- | ------------- | ------------- | -------------
 **height** | **int**| optional block height, defaults to current tip | [optional] 
 **asset** | **str**| the collateral asset | [optional] 
 **amount** | **int**| the collateral asset amount in 1e8 decimals | [optional] 
 **target_asset** | **str**| the target asset to receive (loan denominated in TOR regardless) | [optional] 
