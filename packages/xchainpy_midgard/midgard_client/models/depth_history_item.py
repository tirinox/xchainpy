...
class DepthHistoryItem(object):
    ...
    def __init__(self, asset_depth=None, asset_price=None, asset_price_usd=None, end_time=None, liquidity_units=None, luvi=None, rune_depth=None, start_time=None, synth_supply=None, synth_units=None, units=None):  # noqa: E501
