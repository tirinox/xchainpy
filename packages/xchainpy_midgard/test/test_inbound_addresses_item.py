...
from xchainpy2_midgard.models.inbound_addresses_item import InboundAddressesItem  # noqa: E501
...
class TestInboundAddressesItem(unittest.TestCase):
    ...
    def testInboundAddressesItem(self):
        ...
        # model = xchainpy2_midgard.models.inbound_addresses_item.InboundAddressesItem()  # noqa: E501
        pass
