...
class DefaultApi(object):
    ...
    def get_actions(self, **kwargs):  # noqa: E501
        ...
        :param str asset: Comma separated list. Any asset that is part of the action (CHAIN.SYMBOL) Additionally, synth, nosynth, and norune filters can be used for swap, add/withdraw actions. 
        :param str type: One or more comma separated unique types of action (swap, addLiquidity, withdraw, donate, refund, switch, thorname, runePoolDeposit, runePoolWithdraw) 
        :param str tx_type: One or more comma separated transaction type of the action, it's the tx type parsed from memo. For example: Loan is a swap event but it's considered as loan tx type Type of Transactions:  \"unknown\", \"add\", \"withdraw\", \"swap\", \"limitOrder\", \"outbound\", \"donate\", \"bond\", \"unbond\", \"leave\", \"yggdrasilFund\", \"yggdrasilReturn\", \"reserve\", \"refund\", \"migrate\", \"ragnarok\", \"switch\", \"noOp\", \"consolidate\", \"thorname\", \"loanOpen\", \"loanRepayment\" 
        :param str affiliate: Comma separated list. Affiliate address of the action (swap, refund) 
        :param int limit: number of actions returned, default is 50
        :param int offset: pagination offset, default is 0
        :param int next_page_token: if this is given, the actions for the next page will be given
        ...
        :param int from_timestamp: if this is given, the actions newer than the timestamp will be given
    ...
    def get_actions_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['address', 'txid', 'asset', 'type', 'tx_type', 'affiliate', 'limit', 'offset', 'next_page_token', 'timestamp', 'height', 'prev_page_token', 'from_timestamp', 'from_height']  # noqa: E501
        ...
        if 'tx_type' in params:
            query_params.append(('txType', params['tx_type']))  # noqa: E501
        ...
        if 'prev_page_token' in params:
            query_params.append(('prevPageToken', params['prev_page_token']))  # noqa: E501
        if 'from_timestamp' in params:
            query_params.append(('fromTimestamp', params['from_timestamp']))  # noqa: E501
        if 'from_height' in params:
            query_params.append(('fromHeight', params['from_height']))  # noqa: E501
    ...
    def get_affiliate_earning(self, **kwargs):  # noqa: E501
        """Affiliate Earnings History  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_affiliate_earning(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str thorname: Return earnings for given thorname. Returns all affiliates if missing.
        ...
        :return: list[AffiliateEarningInterval]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_affiliate_earning_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_affiliate_earning_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_affiliate_earning_with_http_info(self, **kwargs):  # noqa: E501
        """Affiliate Earnings History  # noqa: E501

        Returns affiliate earnings (liquidity fees) in USD and RUNE in specified interval. If thorname is not specified returns all affiliates.  History endpoint has two modes: * With Interval parameter it returns a series of time buckets. From and To dates will   be rounded to the Interval boundaries. * Without Interval parameter a single From..To search is performed with exact timestamps.   * Interval: possible values: 5min, hour, day, week, month, quarter, year. * count: [1..400]. Defines number of intervals. Don't provide if Interval is missing. * from/to: optional int, unix second.  Possible usages with interval. * last 10 days: `?interval=day&count=10` * last 10 days before to: `?interval=day&count=10&to=1608825600` * next 10 days after from: `?interval=day&count=10&from=1606780800` * Days between from and to. From defaults to start of chain, to defaults to now.   Only the first 400 intervals are returned:   `interval=day&from=1606780800&to=1608825600`  Pagination is possible with from&count and then using the returned endTime as the From parameter of the next query.  Possible configurations without interval: * exact search for one time frame: `?from=1606780899&to=1608825600` * one time frame until now: `?from=1606780899` * from chain start until now: no query parameters   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_affiliate_earning_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['thorname', 'interval', 'count', 'to', '_from']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_affiliate_earning" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        query_params = []
        if 'thorname' in params:
            query_params.append(('thorname', params['thorname']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v2/history/affiliate/earnings', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='list[AffiliateEarningInterval]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_affiliate_history(self, **kwargs):  # noqa: E501
        """Affiliate earnings History  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_affiliate_history(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str thorname: Return history given thorname. Returns sum of all thornames if missing.
        :param str interval: Interval of calculations
        :param int count: Number of intervals to return. Should be between [1..400].
        :param int to: End time of the query as unix timestamp. If only count is given, defaults to now. 
        :param int _from: Start time of the query as unix timestamp
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_affiliate_history_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_affiliate_history_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_affiliate_history_with_http_info(self, **kwargs):  # noqa: E501
        """Affiliate earnings History  # noqa: E501

        Returns affiliate count, earnings in USD in specified interval. If thorname is not specified returns all thornames  History endpoint has two modes: * With Interval parameter it returns a series of time buckets. From and To dates will   be rounded to the Interval boundaries. * Without Interval parameter a single From..To search is performed with exact timestamps.   * Interval: possible values: 5min, hour, day, week, month, quarter, year. * count: [1..400]. Defines number of intervals. Don't provide if Interval is missing. * from/to: optional int, unix second.  Possible usages with interval. * last 10 days: `?interval=day&count=10` * last 10 days before to: `?interval=day&count=10&to=1608825600` * next 10 days after from: `?interval=day&count=10&from=1606780800` * Days between from and to. From defaults to start of chain, to defaults to now.   Only the first 400 intervals are returned:   `interval=day&from=1606780800&to=1608825600`  Pagination is possible with from&count and then using the returned meta.endTime as the From parameter of the next query.  Possible configurations without interval: * exact search for one time frame: `?from=1606780899&to=1608825600` * one time frame until now: `?from=1606780899` * from chain start until now: no query parameters   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_affiliate_history_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_affiliate_history" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='AffiliateHistory',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_affiliate_stats(self, **kwargs):  # noqa: E501
        """Affiliate Volume Stats  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_affiliate_stats(async_req=True)
        >>> result = thread.get()
        ...
        :param int to: End time of the query as unix timestamp. If only count is given, defaults to now. 
        :param int _from: Start time of the query as unix timestamp
        :return: list[AffiliateStatsItem]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_affiliate_stats_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_affiliate_stats_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_affiliate_stats_with_http_info(self, **kwargs):  # noqa: E501
        """Affiliate Volume Stats  # noqa: E501

        Returns affiliate count, swap volume in USD in specified interval. If thorname is not specified returns all thornames  History endpoint has two modes: * With Interval parameter it returns a series of time buckets. From and To dates will   be rounded to the Interval boundaries. * Without Interval parameter a single From..To search is performed with exact timestamps.   * Interval: possible values: 5min, hour, day, week, month, quarter, year. * count: [1..400]. Defines number of intervals. Don't provide if Interval is missing. * from/to: optional int, unix second.  Possible usages with interval. * last 10 days: `?interval=day&count=10` * last 10 days before to: `?interval=day&count=10&to=1608825600` * next 10 days after from: `?interval=day&count=10&from=1606780800` * Days between from and to. From defaults to start of chain, to defaults to now.   Only the first 400 intervals are returned:   `interval=day&from=1606780800&to=1608825600`  Pagination is possible with from&count and then using the returned meta.endTime as the From parameter of the next query.  Possible configurations without interval: * exact search for one time frame: `?from=1606780899&to=1608825600` * one time frame until now: `?from=1606780899` * from chain start until now: no query parameters   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_affiliate_stats_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_affiliate_stats" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/v2/history/affiliate/stats', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='list[AffiliateStatsItem]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_balance(self, address, **kwargs):  # noqa: E501
        """Current balance for an address  # noqa: E501

        Returns all coin amounts of the given address at the specified timestamp or height, or at the latest process block if neither is provided. (Only one of timestamp or height can be specified, not both.)  This endpoint is enabled only if the midgard startup config allows it.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_balance(address, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str address: Rune address. (required)
        :param int timestamp: Unix timestamp as seconds since 1970 (if provided, height must not be provided)
        :param int height: Block height (if provided, timestamp must not be provided)
        :return: Balance
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_balance_with_http_info(address, **kwargs)  # noqa: E501
        else:
            (data) = self.get_balance_with_http_info(address, **kwargs)  # noqa: E501
            return data

    def get_balance_with_http_info(self, address, **kwargs):  # noqa: E501
        """Current balance for an address  # noqa: E501

        Returns all coin amounts of the given address at the specified timestamp or height, or at the latest process block if neither is provided. (Only one of timestamp or height can be specified, not both.)  This endpoint is enabled only if the midgard startup config allows it.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_balance_with_http_info(address, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['address', 'timestamp', 'height']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_bonders_details(self, address, **kwargs):  # noqa: E501
        """Bonder Details  # noqa: E501

        Returns the bond details of a given address. The response contains the bond amount, the bond status, and the bond type. This is wrapper from THORNode nodes API.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_bonders_details(address, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str address: Address of the bonder (required)
        :return: BonderDetails
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_bonders_details_with_http_info(address, **kwargs)  # noqa: E501
        else:
            (data) = self.get_bonders_details_with_http_info(address, **kwargs)  # noqa: E501
            return data

    def get_bonders_details_with_http_info(self, address, **kwargs):  # noqa: E501
        """Bonder Details  # noqa: E501

        Returns the bond details of a given address. The response contains the bond amount, the bond status, and the bond type. This is wrapper from THORNode nodes API.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_bonders_details_with_http_info(address, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_bonders_details" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'address' is set
        if ('address' not in params or
                params['address'] is None):
            raise ValueError("Missing the required parameter `address` when calling `get_bonders_details`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='BonderDetails',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_borrower_detail(self, address, **kwargs):  # noqa: E501
        """Borrower Details  # noqa: E501

        Returns an array of statistics for all the open loans associated with a given borrower address.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_borrower_detail(address, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str address: Address to match borrower, an asset address is given. Query can also be multiple addresses should be separated by comma (',')  (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_borrower_detail_with_http_info(address, **kwargs)  # noqa: E501
        else:
            (data) = self.get_borrower_detail_with_http_info(address, **kwargs)  # noqa: E501
            return data

    def get_borrower_detail_with_http_info(self, address, **kwargs):  # noqa: E501
        """Borrower Details  # noqa: E501

        Returns an array of statistics for all the open loans associated with a given borrower address.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_borrower_detail_with_http_info(address, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_borrower_detail" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'address' is set
        if ('address' not in params or
                params['address'] is None):
            raise ValueError("Missing the required parameter `address` when calling `get_borrower_detail`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='BorrowerDetails',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_borrowers_addresses(self, **kwargs):  # noqa: E501
        """Borrowers List  # noqa: E501

        Returns an array containing the addresses for all borrowers. Addresses are only shown once.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_borrowers_addresses(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str asset: Return only borrowers getting loan against this asset as collateral.
        :return: list[str]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_borrowers_addresses_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_borrowers_addresses_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_borrowers_addresses_with_http_info(self, **kwargs):  # noqa: E501
        """Borrowers List  # noqa: E501

        Returns an array containing the addresses for all borrowers. Addresses are only shown once.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_borrowers_addresses_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_borrowers_addresses" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_churns(self, **kwargs):  # noqa: E501
        """Churns List  # noqa: E501

        Returns block height and timestamp for each churn.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_churns(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_churns_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_churns_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_churns_with_http_info(self, **kwargs):  # noqa: E501
        """Churns List  # noqa: E501

        Returns block height and timestamp for each churn.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_churns_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def get_health(self, **kwargs):  # noqa: E501
        ...
        Returns an object containing the health response of the API. Meaning of heights:  lastThorNode - Latest block as reported by ThorNode.  lastFetched - Latest block fetched from ThorNode.  lastCommitted - Latest block committed to the DB but not fully processed yet.  lastAggregated - Latest block fully processed and aggregated.  genesisInfo - The genesis height Midgard bootstrapped with.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_holders(self, **kwargs):  # noqa: E501
        """Current top holders for an asset  # noqa: E501

        Returns all coin amounts of the given asset ordered by their amounts in descending order.  This endpoint is enabled only if the midgard startup config allows it.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_holders(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str asset: Asset to get the top holders for.
        :param int limit: Number of top holders to return, default is 100, maximum is 1000.
        :return: list[Holder]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_holders_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_holders_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_holders_with_http_info(self, **kwargs):  # noqa: E501
        """Current top holders for an asset  # noqa: E501

        Returns all coin amounts of the given asset ordered by their amounts in descending order.  This endpoint is enabled only if the midgard startup config allows it.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_holders_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['asset', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[Holder]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_known_pools(self, **kwargs):  # noqa: E501
        """Known Pools List  # noqa: E501

        Returns an object with known pools and their statuses  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_known_pools(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_known_pools_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_known_pools_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_known_pools_with_http_info(self, **kwargs):  # noqa: E501
        """Known Pools List  # noqa: E501

        Returns an object with known pools and their statuses  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_known_pools_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='KnownPools',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_member_detail(self, address, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str address: Address to match liquidity providers. Either a rune or an asset address may be given. Query can also be multiple addresses should be separated by comma (',')  (required)
        :param bool show_savers: A flag to show saver vault membership details, the default is false. 
    ...
    def get_member_detail_with_http_info(self, address, **kwargs):  # noqa: E501
        ...
        all_params = ['address', 'show_savers']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        query_params = []
        if 'show_savers' in params:
            query_params.append(('showSavers', params['show_savers']))  # noqa: E501
    ...
    def get_pools(self, **kwargs):  # noqa: E501
        ...
        :param str period: Specifies the base interval from which annualPercentageRate and poolAPY is extrapolated. Default is 14d. 
    ...
    def get_pools_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['status', 'period']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_reserve_history(self, **kwargs):  # noqa: E501
        """Reserve income and expenses over bucketed history  # noqa: E501

        Returns reserve module network fee, outbound fee, and gas reimbursement flow in bucketed history   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_reserve_history(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_reserve_history_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_reserve_history_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_reserve_history_with_http_info(self, **kwargs):  # noqa: E501
        """Reserve income and expenses over bucketed history  # noqa: E501

        Returns reserve module network fee, outbound fee, and gas reimbursement flow in bucketed history   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_reserve_history_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_reserve_history" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ReserveHistory',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_rune_pool_detail(self, address, **kwargs):  # noqa: E501
        """RUNEPool Details  # noqa: E501

        Returns an array of statistics for all the RUNEPool associated with given member addresses. Query can also be multiple addresses should be separated by comma (',')   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_rune_pool_detail(address, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str address: Address to match the RUNEPool. multiple rune addresses can be given.  (required)
        :return: list[RUNEPoolProvider]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_rune_pool_detail_with_http_info(address, **kwargs)  # noqa: E501
        else:
            (data) = self.get_rune_pool_detail_with_http_info(address, **kwargs)  # noqa: E501
            return data

    def get_rune_pool_detail_with_http_info(self, address, **kwargs):  # noqa: E501
        """RUNEPool Details  # noqa: E501

        Returns an array of statistics for all the RUNEPool associated with given member addresses. Query can also be multiple addresses should be separated by comma (',')   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_rune_pool_detail_with_http_info(address, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_rune_pool_detail" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'address' is set
        if ('address' not in params or
                params['address'] is None):
            raise ValueError("Missing the required parameter `address` when calling `get_rune_pool_detail`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[RUNEPoolProvider]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_rune_pool_history(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_rune_pool_history(async_req=True)
        >>> result = thread.get()
        ...
        :param int to: End time of the query as unix timestamp. If only count is given, defaults to now. 
        :param int _from: Start time of the query as unix timestamp
        :return: RUNEPoolHistory
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_rune_pool_history_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_rune_pool_history_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_rune_pool_history_with_http_info(self, **kwargs):  # noqa: E501
        """RUNEPool total members and units History  # noqa: E501

        Returns RUNEPool members and units. The values report the state at the end of each interval.  History endpoint has two modes: * With Interval parameter it returns a series of time buckets. From and To dates will   be rounded to the Interval boundaries. * Without Interval parameter a single From..To search is performed with exact timestamps.   * Interval: possible values: 5min, hour, day, week, month, quarter, year. * count: [1..400]. Defines number of intervals. Don't provide if Interval is missing. * from/to: optional int, unix second.  Possible usages with interval. * last 10 days: `?interval=day&count=10` * last 10 days before to: `?interval=day&count=10&to=1608825600` * next 10 days after from: `?interval=day&count=10&from=1606780800` * Days between from and to. From defaults to start of chain, to defaults to now.   Only the first 400 intervals are returned:   `interval=day&from=1606780800&to=1608825600`  Pagination is possible with from&count and then using the returned meta.endTime as the From parameter of the next query.  Possible configurations without interval: * exact search for one time frame: `?from=1606780899&to=1608825600` * one time frame until now: `?from=1606780899` * from chain start until now: no query parameters   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_rune_pool_history_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_rune_pool_history" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='RUNEPoolHistory',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_rune_price_history(self, **kwargs):  # noqa: E501
        """Rune price history in USD  # noqa: E501

        Returns rune price history in USD based on the time bucket given   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_rune_price_history(async_req=True)
        >>> result = thread.get()
        ...
        :param int to: End time of the query as unix timestamp. If only count is given, defaults to now. 
        :param int _from: Start time of the query as unix timestamp
        :return: RunePriceHistory
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_rune_price_history_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_rune_price_history_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_rune_price_history_with_http_info(self, **kwargs):  # noqa: E501
        """Rune price history in USD  # noqa: E501

        Returns rune price history in USD based on the time bucket given   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_rune_price_history_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_rune_price_history" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='RunePriceHistory',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_saver_detail(self, address, **kwargs):  # noqa: E501
        """Saver Details  # noqa: E501

        Returns an array of statistics for all the savers associated with a given member address. Query can also be multiple addresses should be separated by comma (',')   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_saver_detail(address, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str address: Address to match the saver. an asset address should be given.  (required)
        :return: SaverDetails
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_saver_detail_with_http_info(address, **kwargs)  # noqa: E501
        else:
            (data) = self.get_saver_detail_with_http_info(address, **kwargs)  # noqa: E501
            return data

    def get_saver_detail_with_http_info(self, address, **kwargs):  # noqa: E501
        """Saver Details  # noqa: E501

        Returns an array of statistics for all the savers associated with a given member address. Query can also be multiple addresses should be separated by comma (',')   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_saver_detail_with_http_info(address, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_saver_detail" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'address' is set
        if ('address' not in params or
                params['address'] is None):
            raise ValueError("Missing the required parameter `address` when calling `get_saver_detail`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='SaverDetails',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_savers_history(self, pool, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_savers_history(pool, async_req=True)
        >>> result = thread.get()
        ...
        :param int to: End time of the query as unix timestamp. If only count is given, defaults to now. 
        :param int _from: Start time of the query as unix timestamp
        :return: SaversHistory
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_savers_history_with_http_info(pool, **kwargs)  # noqa: E501
        else:
            (data) = self.get_savers_history_with_http_info(pool, **kwargs)  # noqa: E501
            return data

    def get_savers_history_with_http_info(self, pool, **kwargs):  # noqa: E501
        """Savers Units and Depth History  # noqa: E501

        Returns savers depths and units. The values report the state at the end of each interval.  History endpoint has two modes: * With Interval parameter it returns a series of time buckets. From and To dates will   be rounded to the Interval boundaries. * Without Interval parameter a single From..To search is performed with exact timestamps.   * Interval: possible values: 5min, hour, day, week, month, quarter, year. * count: [1..400]. Defines number of intervals. Don't provide if Interval is missing. * from/to: optional int, unix second.  Possible usages with interval. * last 10 days: `?interval=day&count=10` * last 10 days before to: `?interval=day&count=10&to=1608825600` * next 10 days after from: `?interval=day&count=10&from=1606780800` * Days between from and to. From defaults to start of chain, to defaults to now.   Only the first 400 intervals are returned:   `interval=day&from=1606780800&to=1608825600`  Pagination is possible with from&count and then using the returned meta.endTime as the From parameter of the next query.  Possible configurations without interval: * exact search for one time frame: `?from=1606780899&to=1608825600` * one time frame until now: `?from=1606780899` * from chain start until now: no query parameters   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_savers_history_with_http_info(pool, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_savers_history" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'pool' is set
        if ('pool' not in params or
                params['pool'] is None):
            raise ValueError("Missing the required parameter `pool` when calling `get_savers_history`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='SaversHistory',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_tcy_distribution(self, address, **kwargs):  # noqa: E501
        """Tcy Distribution  # noqa: E501

        Returns an array of TCY distribution for the given address.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_tcy_distribution(address, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str address: Address which is assigned to TCY Holder. (required)
        :param str period: Specifies the base interval from which APR will be calculated. Default is 30d. 
        :return: TCYDistribution
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_tcy_distribution_with_http_info(address, **kwargs)  # noqa: E501
        else:
            (data) = self.get_tcy_distribution_with_http_info(address, **kwargs)  # noqa: E501
            return data

    def get_tcy_distribution_with_http_info(self, address, **kwargs):  # noqa: E501
        """Tcy Distribution  # noqa: E501

        Returns an array of TCY distribution for the given address.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_tcy_distribution_with_http_info(address, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['address', 'period']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_tcy_distribution" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'address' is set
        if ('address' not in params or
                params['address'] is None):
            raise ValueError("Missing the required parameter `address` when calling `get_tcy_distribution`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v2/tcy/distribution/{address}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='TCYDistribution',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_thor_names_owner_by_address(self, address, **kwargs):  # noqa: E501
        """THORName owner  # noqa: E501

        Returns an array of THORNames owned by the address. The address is not necessarily an associated address for those thornames.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_thor_names_owner_by_address(address, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_thor_names_owner_by_address_with_http_info(address, **kwargs)  # noqa: E501
        else:
            (data) = self.get_thor_names_owner_by_address_with_http_info(address, **kwargs)  # noqa: E501
            return data

    def get_thor_names_owner_by_address_with_http_info(self, address, **kwargs):  # noqa: E501
        """THORName owner  # noqa: E501

        Returns an array of THORNames owned by the address. The address is not necessarily an associated address for those thornames.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_thor_names_owner_by_address_with_http_info(address, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_thor_names_owner_by_address" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'address' is set
        if ('address' not in params or
                params['address'] is None):
            raise ValueError("Missing the required parameter `address` when calling `get_thor_names_owner_by_address`")  # noqa: E501
    ...
    def get_votes(self, **kwargs):  # noqa: E501
        """Current Protocol Voting  # noqa: E501

        Returns timestamp, key, value for each active node member.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_votes(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str period: Specifies the base interval from which votes will be shown. Default is 90d. 
        :return: list[VoteValue]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_votes_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_votes_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_votes_with_http_info(self, **kwargs):  # noqa: E501
        """Current Protocol Voting  # noqa: E501

        Returns timestamp, key, value for each active node member.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_votes_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[VoteValue]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
