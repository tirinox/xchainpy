...
class SwapHistoryItem(object):
    ...
    swagger_types = {
        'average_slip': 'str',
        'end_time': 'str',
        'from_secured_average_slip': 'str',
        'from_secured_count': 'str',
        'from_secured_fees': 'str',
        'from_secured_volume': 'str',
        'from_secured_volume_usd': 'str',
        'from_trade_average_slip': 'str',
        'from_trade_count': 'str',
        'from_trade_fees': 'str',
        'from_trade_volume': 'str',
        'from_trade_volume_usd': 'str',
        'rune_price_usd': 'str',
        'start_time': 'str',
        ...
        'to_secured_average_slip': 'str',
        'to_secured_count': 'str',
        'to_secured_fees': 'str',
        'to_secured_volume': 'str',
        'to_secured_volume_usd': 'str',
        'to_trade_average_slip': 'str',
        'to_trade_count': 'str',
        'to_trade_fees': 'str',
        'to_trade_volume': 'str',
        'to_trade_volume_usd': 'str',
        'total_count': 'str',
        'total_fees': 'str',
        'total_volume': 'str',
    ...
    attribute_map = {
        ...
        'end_time': 'endTime',
        'from_secured_average_slip': 'fromSecuredAverageSlip',
        'from_secured_count': 'fromSecuredCount',
        'from_secured_fees': 'fromSecuredFees',
        'from_secured_volume': 'fromSecuredVolume',
        'from_secured_volume_usd': 'fromSecuredVolumeUSD',
        'from_trade_average_slip': 'fromTradeAverageSlip',
        'from_trade_count': 'fromTradeCount',
        'from_trade_fees': 'fromTradeFees',
        'from_trade_volume': 'fromTradeVolume',
        'from_trade_volume_usd': 'fromTradeVolumeUSD',
        ...
        'to_secured_average_slip': 'toSecuredAverageSlip',
        'to_secured_count': 'toSecuredCount',
        'to_secured_fees': 'toSecuredFees',
        'to_secured_volume': 'toSecuredVolume',
        'to_secured_volume_usd': 'toSecuredVolumeUSD',
        'to_trade_average_slip': 'toTradeAverageSlip',
        'to_trade_count': 'toTradeCount',
        'to_trade_fees': 'toTradeFees',
        'to_trade_volume': 'toTradeVolume',
        'to_trade_volume_usd': 'toTradeVolumeUSD',
    ...
    def __init__(self, average_slip=None, end_time=None, from_secured_average_slip=None, from_secured_count=None, from_secured_fees=None, from_secured_volume=None, from_secured_volume_usd=None, from_trade_average_slip=None, from_trade_count=None, from_trade_fees=None, from_trade_volume=None, from_trade_volume_usd=None, rune_price_usd=None, start_time=None, synth_mint_average_slip=None, synth_mint_count=None, synth_mint_fees=None, synth_mint_volume=None, synth_mint_volume_usd=None, synth_redeem_average_slip=None, synth_redeem_count=None, synth_redeem_fees=None, synth_redeem_volume=None, synth_redeem_volume_usd=None, to_asset_average_slip=None, to_asset_count=None, to_asset_fees=None, to_asset_volume=None, to_asset_volume_usd=None, to_rune_average_slip=None, to_rune_count=None, to_rune_fees=None, to_rune_volume=None, to_rune_volume_usd=None, to_secured_average_slip=None, to_secured_count=None, to_secured_fees=None, to_secured_volume=None, to_secured_volume_usd=None, to_trade_average_slip=None, to_trade_count=None, to_trade_fees=None, to_trade_volume=None, to_trade_volume_usd=None, total_count=None, total_fees=None, total_volume=None, total_volume_usd=None):  # noqa: E501
        """SwapHistoryItem - a model defined in Swagger"""  # noqa: E501
        self._average_slip = None
        self._end_time = None
        self._from_secured_average_slip = None
        self._from_secured_count = None
        self._from_secured_fees = None
        self._from_secured_volume = None
        self._from_secured_volume_usd = None
        self._from_trade_average_slip = None
        self._from_trade_count = None
        self._from_trade_fees = None
        self._from_trade_volume = None
        self._from_trade_volume_usd = None
        ...
        self._to_secured_average_slip = None
        self._to_secured_count = None
        self._to_secured_fees = None
        self._to_secured_volume = None
        self._to_secured_volume_usd = None
        self._to_trade_average_slip = None
        self._to_trade_count = None
        self._to_trade_fees = None
        self._to_trade_volume = None
        self._to_trade_volume_usd = None
        ...
        self.from_secured_average_slip = from_secured_average_slip
        self.from_secured_count = from_secured_count
        self.from_secured_fees = from_secured_fees
        self.from_secured_volume = from_secured_volume
        self.from_secured_volume_usd = from_secured_volume_usd
        self.from_trade_average_slip = from_trade_average_slip
        self.from_trade_count = from_trade_count
        self.from_trade_fees = from_trade_fees
        self.from_trade_volume = from_trade_volume
        self.from_trade_volume_usd = from_trade_volume_usd
        ...
        self.to_secured_average_slip = to_secured_average_slip
        self.to_secured_count = to_secured_count
        self.to_secured_fees = to_secured_fees
        self.to_secured_volume = to_secured_volume
        self.to_secured_volume_usd = to_secured_volume_usd
        self.to_trade_average_slip = to_trade_average_slip
        self.to_trade_count = to_trade_count
        self.to_trade_fees = to_trade_fees
        self.to_trade_volume = to_trade_volume
        self.to_trade_volume_usd = to_trade_volume_usd
    ...
    @property
    def from_secured_average_slip(self):
        """Gets the from_secured_average_slip of this SwapHistoryItem.  # noqa: E501

        Float64 (Basis points, 0-10000, where 10000=100%), the average slip for swaps from asset to secured asset. Big swaps have the same weight as small swaps   # noqa: E501

        :return: The from_secured_average_slip of this SwapHistoryItem.  # noqa: E501
        :rtype: str
        """
        return self._from_secured_average_slip

    @from_secured_average_slip.setter
    def from_secured_average_slip(self, from_secured_average_slip):
        """Sets the from_secured_average_slip of this SwapHistoryItem.

        Float64 (Basis points, 0-10000, where 10000=100%), the average slip for swaps from asset to secured asset. Big swaps have the same weight as small swaps   # noqa: E501

        :param from_secured_average_slip: The from_secured_average_slip of this SwapHistoryItem.  # noqa: E501
        :type: str
        """
        if from_secured_average_slip is None:
            raise ValueError("Invalid value for `from_secured_average_slip`, must not be `None`")  # noqa: E501

        self._from_secured_average_slip = from_secured_average_slip

    @property
    def from_secured_count(self):
        """Gets the from_secured_count of this SwapHistoryItem.  # noqa: E501

        Int64, count of swaps from secured asset to rune  # noqa: E501

        :return: The from_secured_count of this SwapHistoryItem.  # noqa: E501
        :rtype: str
        """
        return self._from_secured_count

    @from_secured_count.setter
    def from_secured_count(self, from_secured_count):
        """Sets the from_secured_count of this SwapHistoryItem.

        Int64, count of swaps from secured asset to rune  # noqa: E501

        :param from_secured_count: The from_secured_count of this SwapHistoryItem.  # noqa: E501
        :type: str
        """
        if from_secured_count is None:
            raise ValueError("Invalid value for `from_secured_count`, must not be `None`")  # noqa: E501

        self._from_secured_count = from_secured_count

    @property
    def from_secured_fees(self):
        """Gets the from_secured_fees of this SwapHistoryItem.  # noqa: E501

        Int64(e8), the fees collected from swaps from rune to secured asset (in rune)  # noqa: E501

        :return: The from_secured_fees of this SwapHistoryItem.  # noqa: E501
        :rtype: str
        """
        return self._from_secured_fees

    @from_secured_fees.setter
    def from_secured_fees(self, from_secured_fees):
        """Sets the from_secured_fees of this SwapHistoryItem.

        Int64(e8), the fees collected from swaps from rune to secured asset (in rune)  # noqa: E501

        :param from_secured_fees: The from_secured_fees of this SwapHistoryItem.  # noqa: E501
        :type: str
        """
        if from_secured_fees is None:
            raise ValueError("Invalid value for `from_secured_fees`, must not be `None`")  # noqa: E501

        self._from_secured_fees = from_secured_fees

    @property
    def from_secured_volume(self):
        """Gets the from_secured_volume of this SwapHistoryItem.  # noqa: E501

        Int64(e8), volume of swaps from rune to secured asset denoted in rune  # noqa: E501

        :return: The from_secured_volume of this SwapHistoryItem.  # noqa: E501
        :rtype: str
        """
        return self._from_secured_volume

    @from_secured_volume.setter
    def from_secured_volume(self, from_secured_volume):
        """Sets the from_secured_volume of this SwapHistoryItem.

        Int64(e8), volume of swaps from rune to secured asset denoted in rune  # noqa: E501

        :param from_secured_volume: The from_secured_volume of this SwapHistoryItem.  # noqa: E501
        :type: str
        """
        if from_secured_volume is None:
            raise ValueError("Invalid value for `from_secured_volume`, must not be `None`")  # noqa: E501

        self._from_secured_volume = from_secured_volume

    @property
    def from_secured_volume_usd(self):
        """Gets the from_secured_volume_usd of this SwapHistoryItem.  # noqa: E501

        Int64(e2), volume of swaps from secured asset to rune denoted in USD price of the rune in each swap  # noqa: E501

        :return: The from_secured_volume_usd of this SwapHistoryItem.  # noqa: E501
        :rtype: str
        """
        return self._from_secured_volume_usd

    @from_secured_volume_usd.setter
    def from_secured_volume_usd(self, from_secured_volume_usd):
        """Sets the from_secured_volume_usd of this SwapHistoryItem.

        Int64(e2), volume of swaps from secured asset to rune denoted in USD price of the rune in each swap  # noqa: E501

        :param from_secured_volume_usd: The from_secured_volume_usd of this SwapHistoryItem.  # noqa: E501
        :type: str
        """
        if from_secured_volume_usd is None:
            raise ValueError("Invalid value for `from_secured_volume_usd`, must not be `None`")  # noqa: E501

        self._from_secured_volume_usd = from_secured_volume_usd

    @property
    def from_trade_average_slip(self):
        """Gets the from_trade_average_slip of this SwapHistoryItem.  # noqa: E501

        Float64 (Basis points, 0-10000, where 10000=100%), the average slip for swaps from asset to trade asset. Big swaps have the same weight as small swaps   # noqa: E501

        :return: The from_trade_average_slip of this SwapHistoryItem.  # noqa: E501
        :rtype: str
        """
        return self._from_trade_average_slip

    @from_trade_average_slip.setter
    def from_trade_average_slip(self, from_trade_average_slip):
        """Sets the from_trade_average_slip of this SwapHistoryItem.

        Float64 (Basis points, 0-10000, where 10000=100%), the average slip for swaps from asset to trade asset. Big swaps have the same weight as small swaps   # noqa: E501

        :param from_trade_average_slip: The from_trade_average_slip of this SwapHistoryItem.  # noqa: E501
        :type: str
        """
        if from_trade_average_slip is None:
            raise ValueError("Invalid value for `from_trade_average_slip`, must not be `None`")  # noqa: E501

        self._from_trade_average_slip = from_trade_average_slip

    @property
    def from_trade_count(self):
        """Gets the from_trade_count of this SwapHistoryItem.  # noqa: E501

        Int64, count of swaps from trade asset to rune  # noqa: E501

        :return: The from_trade_count of this SwapHistoryItem.  # noqa: E501
        :rtype: str
        """
        return self._from_trade_count

    @from_trade_count.setter
    def from_trade_count(self, from_trade_count):
        """Sets the from_trade_count of this SwapHistoryItem.

        Int64, count of swaps from trade asset to rune  # noqa: E501

        :param from_trade_count: The from_trade_count of this SwapHistoryItem.  # noqa: E501
        :type: str
        """
        if from_trade_count is None:
            raise ValueError("Invalid value for `from_trade_count`, must not be `None`")  # noqa: E501

        self._from_trade_count = from_trade_count

    @property
    def from_trade_fees(self):
        """Gets the from_trade_fees of this SwapHistoryItem.  # noqa: E501

        Int64(e8), the fees collected from swaps from rune to trade asset (in rune)  # noqa: E501

        :return: The from_trade_fees of this SwapHistoryItem.  # noqa: E501
        :rtype: str
        """
        return self._from_trade_fees

    @from_trade_fees.setter
    def from_trade_fees(self, from_trade_fees):
        """Sets the from_trade_fees of this SwapHistoryItem.

        Int64(e8), the fees collected from swaps from rune to trade asset (in rune)  # noqa: E501

        :param from_trade_fees: The from_trade_fees of this SwapHistoryItem.  # noqa: E501
        :type: str
        """
        if from_trade_fees is None:
            raise ValueError("Invalid value for `from_trade_fees`, must not be `None`")  # noqa: E501

        self._from_trade_fees = from_trade_fees

    @property
    def from_trade_volume(self):
        """Gets the from_trade_volume of this SwapHistoryItem.  # noqa: E501

        Int64(e8), volume of swaps from rune to trade asset denoted in rune  # noqa: E501

        :return: The from_trade_volume of this SwapHistoryItem.  # noqa: E501
        :rtype: str
        """
        return self._from_trade_volume

    @from_trade_volume.setter
    def from_trade_volume(self, from_trade_volume):
        """Sets the from_trade_volume of this SwapHistoryItem.

        Int64(e8), volume of swaps from rune to trade asset denoted in rune  # noqa: E501

        :param from_trade_volume: The from_trade_volume of this SwapHistoryItem.  # noqa: E501
        :type: str
        """
        if from_trade_volume is None:
            raise ValueError("Invalid value for `from_trade_volume`, must not be `None`")  # noqa: E501

        self._from_trade_volume = from_trade_volume

    @property
    def from_trade_volume_usd(self):
        """Gets the from_trade_volume_usd of this SwapHistoryItem.  # noqa: E501

        Int64(e2), volume of swaps from trade asset to rune denoted in USD price of the rune in each swap  # noqa: E501

        :return: The from_trade_volume_usd of this SwapHistoryItem.  # noqa: E501
        :rtype: str
        """
        return self._from_trade_volume_usd

    @from_trade_volume_usd.setter
    def from_trade_volume_usd(self, from_trade_volume_usd):
        """Sets the from_trade_volume_usd of this SwapHistoryItem.

        Int64(e2), volume of swaps from trade asset to rune denoted in USD price of the rune in each swap  # noqa: E501

        :param from_trade_volume_usd: The from_trade_volume_usd of this SwapHistoryItem.  # noqa: E501
        :type: str
        """
        if from_trade_volume_usd is None:
            raise ValueError("Invalid value for `from_trade_volume_usd`, must not be `None`")  # noqa: E501

        self._from_trade_volume_usd = from_trade_volume_usd
    ...
    @property
    def to_secured_average_slip(self):
        """Gets the to_secured_average_slip of this SwapHistoryItem.  # noqa: E501

        Float64 (Basis points, 0-10000, where 10000=100%), the average slip for swaps from rune to secured asset. Big swaps have the same weight as small swaps   # noqa: E501

        :return: The to_secured_average_slip of this SwapHistoryItem.  # noqa: E501
        :rtype: str
        """
        return self._to_secured_average_slip

    @to_secured_average_slip.setter
    def to_secured_average_slip(self, to_secured_average_slip):
        """Sets the to_secured_average_slip of this SwapHistoryItem.

        Float64 (Basis points, 0-10000, where 10000=100%), the average slip for swaps from rune to secured asset. Big swaps have the same weight as small swaps   # noqa: E501

        :param to_secured_average_slip: The to_secured_average_slip of this SwapHistoryItem.  # noqa: E501
        :type: str
        """
        if to_secured_average_slip is None:
            raise ValueError("Invalid value for `to_secured_average_slip`, must not be `None`")  # noqa: E501

        self._to_secured_average_slip = to_secured_average_slip

    @property
    def to_secured_count(self):
        """Gets the to_secured_count of this SwapHistoryItem.  # noqa: E501

        Int64, count of swaps from rune to secured asset  # noqa: E501

        :return: The to_secured_count of this SwapHistoryItem.  # noqa: E501
        :rtype: str
        """
        return self._to_secured_count

    @to_secured_count.setter
    def to_secured_count(self, to_secured_count):
        """Sets the to_secured_count of this SwapHistoryItem.

        Int64, count of swaps from rune to secured asset  # noqa: E501

        :param to_secured_count: The to_secured_count of this SwapHistoryItem.  # noqa: E501
        :type: str
        """
        if to_secured_count is None:
            raise ValueError("Invalid value for `to_secured_count`, must not be `None`")  # noqa: E501

        self._to_secured_count = to_secured_count

    @property
    def to_secured_fees(self):
        """Gets the to_secured_fees of this SwapHistoryItem.  # noqa: E501

        Int64(e8), the fees collected from swaps from rune to secured asset (in rune)  # noqa: E501

        :return: The to_secured_fees of this SwapHistoryItem.  # noqa: E501
        :rtype: str
        """
        return self._to_secured_fees

    @to_secured_fees.setter
    def to_secured_fees(self, to_secured_fees):
        """Sets the to_secured_fees of this SwapHistoryItem.

        Int64(e8), the fees collected from swaps from rune to secured asset (in rune)  # noqa: E501

        :param to_secured_fees: The to_secured_fees of this SwapHistoryItem.  # noqa: E501
        :type: str
        """
        if to_secured_fees is None:
            raise ValueError("Invalid value for `to_secured_fees`, must not be `None`")  # noqa: E501

        self._to_secured_fees = to_secured_fees

    @property
    def to_secured_volume(self):
        """Gets the to_secured_volume of this SwapHistoryItem.  # noqa: E501

        Int64(e8), volume of swaps from secured asset to rune denoted in rune  # noqa: E501

        :return: The to_secured_volume of this SwapHistoryItem.  # noqa: E501
        :rtype: str
        """
        return self._to_secured_volume

    @to_secured_volume.setter
    def to_secured_volume(self, to_secured_volume):
        """Sets the to_secured_volume of this SwapHistoryItem.

        Int64(e8), volume of swaps from secured asset to rune denoted in rune  # noqa: E501

        :param to_secured_volume: The to_secured_volume of this SwapHistoryItem.  # noqa: E501
        :type: str
        """
        if to_secured_volume is None:
            raise ValueError("Invalid value for `to_secured_volume`, must not be `None`")  # noqa: E501

        self._to_secured_volume = to_secured_volume

    @property
    def to_secured_volume_usd(self):
        """Gets the to_secured_volume_usd of this SwapHistoryItem.  # noqa: E501

        Int64(e2), volume of swaps from rune to secured asset denoted in USD price of the rune in each swap  # noqa: E501

        :return: The to_secured_volume_usd of this SwapHistoryItem.  # noqa: E501
        :rtype: str
        """
        return self._to_secured_volume_usd

    @to_secured_volume_usd.setter
    def to_secured_volume_usd(self, to_secured_volume_usd):
        """Sets the to_secured_volume_usd of this SwapHistoryItem.

        Int64(e2), volume of swaps from rune to secured asset denoted in USD price of the rune in each swap  # noqa: E501

        :param to_secured_volume_usd: The to_secured_volume_usd of this SwapHistoryItem.  # noqa: E501
        :type: str
        """
        if to_secured_volume_usd is None:
            raise ValueError("Invalid value for `to_secured_volume_usd`, must not be `None`")  # noqa: E501

        self._to_secured_volume_usd = to_secured_volume_usd

    @property
    def to_trade_average_slip(self):
        """Gets the to_trade_average_slip of this SwapHistoryItem.  # noqa: E501

        Float64 (Basis points, 0-10000, where 10000=100%), the average slip for swaps from rune to trade asset. Big swaps have the same weight as small swaps   # noqa: E501

        :return: The to_trade_average_slip of this SwapHistoryItem.  # noqa: E501
        :rtype: str
        """
        return self._to_trade_average_slip

    @to_trade_average_slip.setter
    def to_trade_average_slip(self, to_trade_average_slip):
        """Sets the to_trade_average_slip of this SwapHistoryItem.

        Float64 (Basis points, 0-10000, where 10000=100%), the average slip for swaps from rune to trade asset. Big swaps have the same weight as small swaps   # noqa: E501

        :param to_trade_average_slip: The to_trade_average_slip of this SwapHistoryItem.  # noqa: E501
        :type: str
        """
        if to_trade_average_slip is None:
            raise ValueError("Invalid value for `to_trade_average_slip`, must not be `None`")  # noqa: E501

        self._to_trade_average_slip = to_trade_average_slip

    @property
    def to_trade_count(self):
        """Gets the to_trade_count of this SwapHistoryItem.  # noqa: E501

        Int64, count of swaps from rune to trade asset  # noqa: E501

        :return: The to_trade_count of this SwapHistoryItem.  # noqa: E501
        :rtype: str
        """
        return self._to_trade_count

    @to_trade_count.setter
    def to_trade_count(self, to_trade_count):
        """Sets the to_trade_count of this SwapHistoryItem.

        Int64, count of swaps from rune to trade asset  # noqa: E501

        :param to_trade_count: The to_trade_count of this SwapHistoryItem.  # noqa: E501
        :type: str
        """
        if to_trade_count is None:
            raise ValueError("Invalid value for `to_trade_count`, must not be `None`")  # noqa: E501

        self._to_trade_count = to_trade_count

    @property
    def to_trade_fees(self):
        """Gets the to_trade_fees of this SwapHistoryItem.  # noqa: E501

        Int64(e8), the fees collected from swaps from rune to trade asset (in rune)  # noqa: E501

        :return: The to_trade_fees of this SwapHistoryItem.  # noqa: E501
        :rtype: str
        """
        return self._to_trade_fees

    @to_trade_fees.setter
    def to_trade_fees(self, to_trade_fees):
        """Sets the to_trade_fees of this SwapHistoryItem.

        Int64(e8), the fees collected from swaps from rune to trade asset (in rune)  # noqa: E501

        :param to_trade_fees: The to_trade_fees of this SwapHistoryItem.  # noqa: E501
        :type: str
        """
        if to_trade_fees is None:
            raise ValueError("Invalid value for `to_trade_fees`, must not be `None`")  # noqa: E501

        self._to_trade_fees = to_trade_fees

    @property
    def to_trade_volume(self):
        """Gets the to_trade_volume of this SwapHistoryItem.  # noqa: E501

        Int64(e8), volume of swaps from trade asset to rune denoted in rune  # noqa: E501

        :return: The to_trade_volume of this SwapHistoryItem.  # noqa: E501
        :rtype: str
        """
        return self._to_trade_volume

    @to_trade_volume.setter
    def to_trade_volume(self, to_trade_volume):
        """Sets the to_trade_volume of this SwapHistoryItem.

        Int64(e8), volume of swaps from trade asset to rune denoted in rune  # noqa: E501

        :param to_trade_volume: The to_trade_volume of this SwapHistoryItem.  # noqa: E501
        :type: str
        """
        if to_trade_volume is None:
            raise ValueError("Invalid value for `to_trade_volume`, must not be `None`")  # noqa: E501

        self._to_trade_volume = to_trade_volume

    @property
    def to_trade_volume_usd(self):
        """Gets the to_trade_volume_usd of this SwapHistoryItem.  # noqa: E501

        Int64(e2), volume of swaps from rune to trade asset denoted in USD price of the rune in each swap  # noqa: E501

        :return: The to_trade_volume_usd of this SwapHistoryItem.  # noqa: E501
        :rtype: str
        """
        return self._to_trade_volume_usd

    @to_trade_volume_usd.setter
    def to_trade_volume_usd(self, to_trade_volume_usd):
        """Sets the to_trade_volume_usd of this SwapHistoryItem.

        Int64(e2), volume of swaps from rune to trade asset denoted in USD price of the rune in each swap  # noqa: E501

        :param to_trade_volume_usd: The to_trade_volume_usd of this SwapHistoryItem.  # noqa: E501
        :type: str
        """
        if to_trade_volume_usd is None:
            raise ValueError("Invalid value for `to_trade_volume_usd`, must not be `None`")  # noqa: E501

        self._to_trade_volume_usd = to_trade_volume_usd
