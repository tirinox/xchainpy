...
class Network(object):
    ...
    def __init__(self, active_bonds=None, active_node_count=None, block_rewards=None, bond_metrics=None, bonding_apy=None, liquidity_apy=None, next_churn_height=None, pool_activation_countdown=None, pool_share_factor=None, standby_bonds=None, standby_node_count=None, total_pooled_rune=None, total_reserve=None):  # noqa: E501
    ...
    def active_bonds(self):
        ...
        Array of rune amounts (e8) bonded by each active node.   # noqa: E501
    ...
    def bonding_apy(self):
        ...
        Float, E.g. 0.01 = 1%. Estimate of the compounded bonding earnings based on the current reserve size, emmission curve, blocks per year and pool share factor = (WeeklyBondIncome/BondAmount + 1)^52 - 1   # noqa: E501
    ...
    def liquidity_apy(self):
        ...
        Float, E.g. 0.01 = 1%. Estimate of the compounded  liquidity provider earnings based on the current reserve size, emmission curve, blocks per year and pool share factor = (WeeklyLiquidityIncome/(totalPooledRune*2) + 1)^52 - 1   # noqa: E501
    ...
    def next_churn_height(self):
        ...
        Int64, height (block number) of the next churn.  # noqa: E501
    ...
    def pool_share_factor(self):
        ...
        Float [0..1], the ratio which is used to split earnings between liquidity provider and nodes. LPIncome = rewards * poolShareFactor ; BondIncome :=  rewards * (1 - poolShareFactor)   # noqa: E501
    ...
    def standby_bonds(self):
        ...
        Array of rune amounts (e8) bonded by each standby node.   # noqa: E501
    ...
    def standby_node_count(self):
        ...
        Int64, Number of standby nodes, some of them might become active at the next churn.   # noqa: E501
    ...
    def total_pooled_rune(self):
        ...
        Int64(e8), total Rune in all pools. Because asset and Rune value is the same amount in every pool (by definition), the total amount pooled is totalPooledRune*2.   # noqa: E501
    ...
    def total_reserve(self):
        ...
        Int64(e8), Current size of the Reserve.  # noqa: E501
