...
class MemberPool(object):
    ...
    def __init__(self, asset_added=None, asset_address=None, asset_pending=None, asset_withdrawn=None, date_first_added=None, date_last_added=None, liquidity_units=None, pool=None, rune_added=None, rune_address=None, rune_pending=None, rune_withdrawn=None):  # noqa: E501
