...
class DepthHistoryMeta(object):
    ...
    def __init__(self, end_asset_depth=None, end_lp_units=None, end_rune_depth=None, end_synth_units=None, end_time=None, luvi_increase=None, price_shift_loss=None, start_asset_depth=None, start_lp_units=None, start_rune_depth=None, start_synth_units=None, start_time=None):  # noqa: E501
