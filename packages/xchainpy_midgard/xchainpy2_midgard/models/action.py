...
class Action(object):
    ...
    def status(self):
        ...
        Indicates if the action is completed or if related outbound transactions are still pending, failed to be processed.   # noqa: E501
    ...
    def status(self, status):
        ...
        allowed_values = ["success", "pending", "failed"]  # noqa: E501
    ...
    def type(self, type):
        ...
        allowed_values = ["swap", "addLiquidity", "withdraw", "donate", "refund", "switch", "thorname", "send", "runePoolDeposit", "runePoolWithdraw"]  # noqa: E501
