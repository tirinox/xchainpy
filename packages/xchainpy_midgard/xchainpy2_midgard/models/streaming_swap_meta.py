...
class StreamingSwapMeta(object):
    ...
    attribute_map = {
        ...
        'out_coin': 'outCoin',
        'out_estimation': 'outEstimation',
        'quantity': 'quantity'
    }

    def __init__(self, count=None, deposited_coin=None, failed_swap_reasons=None, failed_swaps=None, in_coin=None, interval=None, last_height=None, out_coin=None, out_estimation=None, quantity=None):  # noqa: E501
        ...
        self.out_estimation = out_estimation
    ...
    @property
    def out_estimation(self):
        """Gets the out_estimation of this StreamingSwapMeta.  # noqa: E501

        Int64, The estimated output based on the first swap block * quantity. This is the current method quote calculate the estimation.   # noqa: E501

        :return: The out_estimation of this StreamingSwapMeta.  # noqa: E501
        :rtype: str
        """
        return self._out_estimation

    @out_estimation.setter
    def out_estimation(self, out_estimation):
        """Sets the out_estimation of this StreamingSwapMeta.

        Int64, The estimated output based on the first swap block * quantity. This is the current method quote calculate the estimation.   # noqa: E501

        :param out_estimation: The out_estimation of this StreamingSwapMeta.  # noqa: E501
        :type: str
        """
        if out_estimation is None:
            raise ValueError("Invalid value for `out_estimation`, must not be `None`")  # noqa: E501

        self._out_estimation = out_estimation
