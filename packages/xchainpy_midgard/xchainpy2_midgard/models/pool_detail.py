...
class PoolDetail(object):
    ...
    swagger_types = {
        ...
        'asset_price': 'str',
        'asset_price_usd': 'str',
        'depth_minus2_percent': 'str',
        'depth_plus2_percent': 'str',
        'earnings': 'str',
    ...
    attribute_map = {
        ...
        'depth_minus2_percent': 'depthMinus2Percent',
        'depth_plus2_percent': 'depthPlus2Percent',
        'earnings': 'earnings',
    ...
    def __init__(self, annual_percentage_rate=None, asset=None, asset_depth=None, asset_price=None, asset_price_usd=None, depth_minus2_percent=None, depth_plus2_percent=None, earnings=None, earnings_annual_as_percent_of_depth=None, liquidity_units=None, lp_luvi=None, native_decimal=None, pool_apy=None, rune_depth=None, savers_apr=None, savers_depth=None, savers_units=None, savers_yield_share=None, status=None, synth_supply=None, synth_units=None, total_collateral=None, total_debt_tor=None, units=None, volume24h=None):  # noqa: E501
        ...
        self._depth_minus2_percent = None
        self._depth_plus2_percent = None
        self._earnings = None
        ...
        if depth_minus2_percent is not None:
            self.depth_minus2_percent = depth_minus2_percent
        if depth_plus2_percent is not None:
            self.depth_plus2_percent = depth_plus2_percent
    ...
    @property
    def depth_minus2_percent(self):
        """Gets the depth_minus2_percent of this PoolDetail.  # noqa: E501

        Int64(e8), liquidity depth at -2% price movement calculated using Uniswap V2 constant product formula with fee from L1SLIPMINBPS mimir value. Represents the maximum RUNE value that can be traded before the pool price decreases by 2%.   # noqa: E501

        :return: The depth_minus2_percent of this PoolDetail.  # noqa: E501
        :rtype: str
        """
        return self._depth_minus2_percent

    @depth_minus2_percent.setter
    def depth_minus2_percent(self, depth_minus2_percent):
        """Sets the depth_minus2_percent of this PoolDetail.

        Int64(e8), liquidity depth at -2% price movement calculated using Uniswap V2 constant product formula with fee from L1SLIPMINBPS mimir value. Represents the maximum RUNE value that can be traded before the pool price decreases by 2%.   # noqa: E501

        :param depth_minus2_percent: The depth_minus2_percent of this PoolDetail.  # noqa: E501
        :type: str
        """

        self._depth_minus2_percent = depth_minus2_percent

    @property
    def depth_plus2_percent(self):
        """Gets the depth_plus2_percent of this PoolDetail.  # noqa: E501

        Int64(e8), liquidity depth at +2% price movement calculated using Uniswap V2 constant product formula with fee from L1SLIPMINBPS mimir value. Represents the maximum RUNE value that can be traded before the pool price increases by 2%.   # noqa: E501

        :return: The depth_plus2_percent of this PoolDetail.  # noqa: E501
        :rtype: str
        """
        return self._depth_plus2_percent

    @depth_plus2_percent.setter
    def depth_plus2_percent(self, depth_plus2_percent):
        """Sets the depth_plus2_percent of this PoolDetail.

        Int64(e8), liquidity depth at +2% price movement calculated using Uniswap V2 constant product formula with fee from L1SLIPMINBPS mimir value. Represents the maximum RUNE value that can be traded before the pool price increases by 2%.   # noqa: E501

        :param depth_plus2_percent: The depth_plus2_percent of this PoolDetail.  # noqa: E501
        :type: str
        """

        self._depth_plus2_percent = depth_plus2_percent
