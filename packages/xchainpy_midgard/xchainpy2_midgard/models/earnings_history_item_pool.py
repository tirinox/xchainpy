...
class EarningsHistoryItemPool(object):
    ...
    attribute_map = {
        ...
        'saver_earning': 'saverEarning',
        'total_liquidity_fees_rune': 'totalLiquidityFeesRune'
    }

    def __init__(self, asset_liquidity_fees=None, earnings=None, pool=None, rewards=None, rune_liquidity_fees=None, saver_earning=None, total_liquidity_fees_rune=None):  # noqa: E501
        ...
        self.saver_earning = saver_earning
    ...
    @property
    def saver_earning(self):
        """Gets the saver_earning of this EarningsHistoryItemPool.  # noqa: E501

        Int64(e8), total saver reward collected by the pool, shown in pool's ASSET   # noqa: E501

        :return: The saver_earning of this EarningsHistoryItemPool.  # noqa: E501
        :rtype: str
        """
        return self._saver_earning

    @saver_earning.setter
    def saver_earning(self, saver_earning):
        """Sets the saver_earning of this EarningsHistoryItemPool.

        Int64(e8), total saver reward collected by the pool, shown in pool's ASSET   # noqa: E501

        :param saver_earning: The saver_earning of this EarningsHistoryItemPool.  # noqa: E501
        :type: str
        """
        if saver_earning is None:
            raise ValueError("Invalid value for `saver_earning`, must not be `None`")  # noqa: E501

        self._saver_earning = saver_earning
