...
class SwapMetadata(object):
    ...
    def __init__(self, affiliate_address=None, affiliate_fee=None, in_price_usd=None, is_streaming_swap=None, liquidity_fee=None, memo=None, network_fees=None, out_price_usd=None, streaming_swap_meta=None, swap_slip=None, swap_target=None, tx_type=None):  # noqa: E501
        """SwapMetadata - a model defined in Swagger"""  # noqa: E501
        self._affiliate_address = None
        self._affiliate_fee = None
        self._in_price_usd = None
        self._is_streaming_swap = None
        self._liquidity_fee = None
        self._memo = None
        self._network_fees = None
        self._out_price_usd = None
    ...
    @property
    def in_price_usd(self):
        """Gets the in_price_usd of this SwapMetadata.  # noqa: E501

        in asset price usd at the first interval  # noqa: E501

        :return: The in_price_usd of this SwapMetadata.  # noqa: E501
        :rtype: str
        """
        return self._in_price_usd

    @in_price_usd.setter
    def in_price_usd(self, in_price_usd):
        """Sets the in_price_usd of this SwapMetadata.

        in asset price usd at the first interval  # noqa: E501

        :param in_price_usd: The in_price_usd of this SwapMetadata.  # noqa: E501
        :type: str
        """
        if in_price_usd is None:
            raise ValueError("Invalid value for `in_price_usd`, must not be `None`")  # noqa: E501

        self._in_price_usd = in_price_usd
    ...
    @property
    def out_price_usd(self):
        """Gets the out_price_usd of this SwapMetadata.  # noqa: E501

        out asset price usd at the first interval  # noqa: E501

        :return: The out_price_usd of this SwapMetadata.  # noqa: E501
        :rtype: str
        """
        return self._out_price_usd

    @out_price_usd.setter
    def out_price_usd(self, out_price_usd):
        """Sets the out_price_usd of this SwapMetadata.

        out asset price usd at the first interval  # noqa: E501

        :param out_price_usd: The out_price_usd of this SwapMetadata.  # noqa: E501
        :type: str
        """
        if out_price_usd is None:
            raise ValueError("Invalid value for `out_price_usd`, must not be `None`")  # noqa: E501

        self._out_price_usd = out_price_usd
